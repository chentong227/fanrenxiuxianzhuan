...
const TRACKS = {
  ...
  combat: {
    lead: "急促战鼓与大鼓滚奏为骨架驱动全曲，二胡与弦乐群高把位急奏（tremolo 与 staccato）拉出紧张线条，竹笛短促锐利穿插，梆子密集敲击",
    mood: "商调式偏暗，凶险斗法的紧张与危机感，剑拔弩张、步步进逼、险象环生，激烈而有章法不靠噪音堆砌；无唢呐、无铜管、无人声",
    tempo: "快速，约 140 BPM，密集驱动的强拍，紧迫不松懈",
    loop: "约 30 秒，鼓点与弦乐张力持续贯穿，段落循环平滑反复不腻",
  },
  // 野外/路上遭遇战（与 journey 行旅乐配套）：苍茫旷野里的凶险
  combat_wild: {
    lead: "急促战鼓与梆子驱动，竹笛与梆笛高亢主线，弦乐群急奏铺底，马蹄般的低音律动",
    mood: "羽调式偏紧，旷野遭遇战的苍茫与凶险，风沙裹挟刀光、开阔而危机四伏；激烈不靠噪音堆砌；无唢呐、无铜管、无人声",
    tempo: "快速，约 138 BPM，奔突推进的强拍",
    loop: "约 30 秒，鼓点贯穿张力，段落循环平滑反复不腻",
  },
  // 秘境/险境斗法（与 tense 阴冷乐配套）：幽暗中的杀机
  combat_secret: {
    lead: "低音战鼓与定音鼓暗涌，二胡与弦乐高把位诡谲滑奏，编钟与古筝泛音冷冽点缀，箫声尖利穿插",
    mood: "无明确调中心偏暗，秘境凶险斗法的诡谲与压迫，幽暗中杀机暗藏、险象环生；激烈而阴冷不靠噪音堆砌；无唢呐、无铜管、无人声",
    tempo: "快速，约 132 BPM，暗涌驱动、骤紧骤松",
    loop: "约 30 秒，鼓与弦张力持续，段落循环平滑反复不腻",
  },
  // 决战/妖王/越级（boss）：压迫史诗——激昂只在这里（v312 重写：用户实锤旧轨"没感觉"——要热血滚烫的巅峰对决感）
  boss: {
    lead: "重型太鼓群与战鼓滚奏轰鸣开场立刻拉满，低音弦乐群狂暴齐奏推进，唢呐高亢撕裂长音点睛（克制使用），古筝急速轮指扫弦如剑雨，钹镲重击与锣声炸点",
    mood: "小调式，热血滚烫的巅峰生死决战，狂澜压顶又绝地反击的燃与悲壮交织，情绪始终在沸点、层层再往上顶；无人声",
    tempo: "快速强推，约 128 BPM，重锤强拍连绵不断，副歌段全乐器齐轰",
