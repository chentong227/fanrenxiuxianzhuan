...
const BATTLE_DEFS = {
  ...
  xueyu_zhizhu: { kind: "portrait", hq: true, prompt: "图鉴立绘·血玉蜘蛛（剧版《凡人修仙传》动画3D渲染风·圆润软萌灵兽向）：一头通体莹白如羊脂玉的蛛妖半身像，圆滚滚饱满的玉色身躯憨态可掬，温润白玉之上天然游走着淡淡的血红玉纹（血玉之名所本），一对又大又圆、乌黑澄澈的大眼睛纯真灵动、神情温顺毫不凶恶，小巧颚部内收、不露獠牙，短足覆白玉甲、线条圆融、足尖收圆、骨节透淡红，整体卡通灵兽质感、软萌讨喜又透玉质灵气，干净的纯黑色背景、主体边缘清晰分明便于抠像" },
  // 战斗全身立绘（battlers/）
  ...
  bt_xueyu_zhizhu: { kind: "battler", hq: true,
               prompt: "一头血玉蜘蛛（剧版《凡人修仙传》动画3D渲染风·圆润软萌灵兽向）的完整全身，圆滚滚饱满的羊脂白玉色身躯、温玉光泽，白玉之上天然游走着淡淡的血红玉纹（血玉之名所本），一对又大又圆、乌黑澄澈的大眼睛纯真灵动、神情温顺憨萌，小巧颚部内收不露獠牙，八只短足覆白玉甲、线条圆融柔和、足尖收圆不露锋芒、骨节透淡红，体态圆胖可爱讨喜，整体卡通灵兽质感而非写实蜘蛛，干净的纯黑色背景、主体轮廓清晰分明便于抠像" },
