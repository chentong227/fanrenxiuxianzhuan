...
const BATTLE_DEFS = {
  ...
  xueyu_zhizhu: { kind: "portrait", hq: true, guard: true, prompt: "图鉴立绘·血玉蜘蛛：四级蛛妖的半身特写，巨大的血玉色甲壳蛛首占据画面，一对猩红复眼幽光慑人，巨颚獠牙微张，甲壳暗红如凝血泛着温润玉光、关节处隐透白玉底色，背景幽暗矿洞结着暗红蛛丝网，妖异凶丽" },
  // 战斗全身立绘（battlers/）
  ...
  bt_xueyu_zhizhu: { kind: "battler", hq: true, guard: true,
               prompt: "一头四级蛛妖·血玉蜘蛛，体型如磨盘般巨大的蜘蛛妖兽，通体覆盖半透的血玉色甲壳（暗红如凝血的玉质甲壳泛着温润光泽、关节处隐透白玉底色），八足如戟、足尖锋利如骨刃撑地，头胸前一对猩红复眼如鬼火幽幽，巨颚獠牙森然外张，腹下垂着血色丝囊，周身缭绕暗红土煞妖气，封印松脱后狂暴凶戾、压迫感十足的狂化凶相" },
