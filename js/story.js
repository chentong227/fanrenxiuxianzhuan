...
const STORY = [
    ...
    text: [
      ...
      { stage: {
        ...
        units: [
          ...
          { id: "tienu", art: "bt_tienu", pos: 8, name: "铁奴", face: "l" },
        ],
        script: [
          { freeMove: true, hint: "轻触格子，潜行靠近密室", trigger: { npc: "tienu", radius: 2 } },
          { fx: "flash", color: "#0a0a12", alpha: 0.45, ms: 320 },
          { narr: "门缝里透出幽幽的光。一具铁灰色、毫无生气的人偶，正被诡异的术法驱使着缓缓转身。那身形、那轮廓——" },
          { say: "hanli", text: "……张铁？" },
          { bgm: "sorrow" },
          { wait: 800 },
          { narr: "挚友早已被害，尸身被魔道之术炼成了无魂的「铁奴」。七玄门的温情，原来从头到尾都是一张网。" },
          { cgOut: true },
        ],
      }},
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { narr: "他自以为算无遗策——却不知你早已暗修到练气四层，更不知你手里藏着那只小绿瓶。" },
          { narr: "硬拼，绝无胜算。你不动声色，用小绿瓶催熟墨大夫药圃里的毒草，又日夜苦练那卷诡谲的「眨眼剑法」。" },
  ...
  /* ---- B6 反杀墨大夫（三阶段战斗）---- */
  {
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          { sfx: "danger" },
          { say: "modafu", text: "乖徒儿，养了你这么些年……这具好皮囊，也该还给为师了。" },
          { narr: "来了。你心跳如鼓，面上却古井无波——这一刻，你已等了太久。" },
          { wait: 600 },
          { narr: "眨眼剑法、催熟的剧毒、藏在袖中的暗器，还有这数年隐忍苦修的功力……全得用上。成败，就在今夜。" },
          { narr: "（铁奴百毒不侵，须正面破之；余子童元神非血肉，唯运功镇魂可灭。备得越足，胜算越大。）" },
          { cam: "shake", px: 8 },
          { fx: "flash", color: "#ff0000", alpha: 0.3, ms: 200 },
          { combat: "showdown_win", inheritPos: true },
        ],
      }},
    ],
    choices: [
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { narr: "你收殓了遗物：储物袋、灵石、灵药、毒方、《长春功》的后续口诀，还有那具沉默的尸傀——日后随你闯荡的「曲魂」。" },
          { bgm: "sorrow" },
          { cam: "zoom", scale: 1.1, ms: 600 },
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { sfx: "hit" },
          { cam: "shake", px: 6 },
          { narr: "金符、剑符、金钟罩，道道术法璀璨夺目。三位武艺最高的师叔联手而上——" },
          { wait: 600 },
  ...
  /* ---- C3 反杀金光上人（战斗）---- */
  {
    ...
    text: [
      ...
      { stage: {
        ...
        units: [
          { id: "hanli", art: "bt_hanli", pos: 2, name: "韩立", face: "r" },
          { id: "jinguang", art: "bt_jinguang", pos: 7, name: "金光上人", face: "l" },
        ],
        script: [
          { move: "hanli", to: 5, ms: 1800 },
          { narr: "金钟罩再固，也挡不住由内而发的毒。" },
          { wait: 400 },
          { sfx: "backstab" },
          { fx: "flash", color: "#fff", alpha: 0.3, ms: 200 },
          { narr: "催熟的剧毒、淬毒的暗器，尽数招呼上去。一击不中，便是粉身碎骨；可一旦得手……" },
          { combat: "jinguang_win", inheritPos: true },
        ],
      }},
    ],
    choices: [
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { narr: "……墨大夫信里到底写了什么。" },
          { say: "mocaihuan", emo: "scheme", text: "娘说了，爹的弟子就是自家人。进来吧——哎对了，你包袱里那是什么香味？萦香丸？给我看看嘛，就看一眼！" },
        ...
        script: [
          ...
          { beat: {
              ...
              onHit: {
                ...
                fx: { fx: "burst", at: 9, elem: "jin", n: 14 },
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { say: "mocaihuan", tone: "故作轻快", text: "我们姐妹每人都有一份嫁妆，这玉是我的。我同娘说了——我不成亲，便不需要嫁妆了呀。" },
          { fx: "flash", color: "#ffd27a", alpha: 0.35, ms: 600 },
          { sfx: "heal" },
          { narr: "玉贴上丹田的一刻，暖流如春水化冰，寒毒节节败退。你长出一口气，多日的阴寒一扫而空。" },
          { bgm: "sorrow" },
          { say: "mocaihuan", emo: "sad", tone: "轻声", text: "韩立……凡人，就真的不能修仙吗？" },
          { narr: "你答不上来。你也曾是凡人——你拼了命才摸到这条路的门槛。而对她来说，这条路生来就是断的。" },
          { say: "mocaihuan", text: "对了，你要找修仙的人吧？我听爹提过——岚州最南的太南山里，每隔几年有个「太南小会」，是修仙人的集市。算日子，快开了。" },
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { say: "wanxiaoshan", text: "我看兄台气息，是练气中后期？厉害呀！我家祖上说，散修最要紧三件事：一不露财，二不结仇，三——逛集市要带个识货的！走走走，我带你转转！" },
          { narr: "他半点不见外地拉着你穿行摊位之间：哪家符纸是真货，哪摊「灵丹」是糖丸，何处的功法残卷值得一翻——如数家珍。" },
          { narr: "修仙人多凉薄，这人倒是热得反常。是真心善，还是另有所图……且看着吧。" },
          { cam: "pan", to: { x: -3, y: 0 }, ms: 800 },
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { bgm: "tense" },
          { say: "hanli", tone: "平静", text: "摊位费？也好。道长先把『散修盟』的印信请出来一观——再让你身后这位，把方才顺走的三只香囊还了。" },
          { wait: 400 },
          { sfx: "danger" },
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { say: "hanli", tone: "平静", text: "……四属性，伪灵根。" },
          { narr: "台下一阵低低的嗤笑。有人摇头：「四灵根还来凑什么热闹。」" },
          { narr: "嗤笑就嗤笑吧。你们不知道的是——我袖中有一枚升仙令。" },
  ...
  },
  {
    ...
    text: [
      ...
      { stage: {
        ...
        units: [
          { id: "hanli", art: "bt_hanli", pos: 1, name: "韩立", face: "r" },
          { id: "wanxiaoshan", art: "bt_wanxiaoshan", pos: 8, name: "万小山", face: "l" },
          { id: "sanxiu1", art: "bt_sanxiu", pos: 9, name: "刀疤散修", face: "l" },
          { id: "sanxiu2", art: "bt_sanxiu", pos: 10, name: "散修", face: "l" },
          { id: "sanxiu3", art: "bt_sanxiu", pos: 7, name: "散修", face: "l" },
        ],
        script: [
          { freeMove: true, hint: "沿血迹深入林中……", trigger: { npc: "sanxiu1", radius: 3 } },
          { narr: "林间空地，万小山仰面躺着，行囊被翻得底朝天，胸前一个焦黑的掌印。三个散修正蹲在他身边分拣财物，见你来了，懒洋洋地抬眼。" },
          { wait: 700 },
          { say: "sanxiu1", text: "哟，又来一个肥羊。这穷小子身上就几块灵石，你身上想必多些——" },
          { narr: "万小山的眼睛还睁着，望着天。那个在集市上拉着你、教你『散修最要紧三件事』的人，到死攥着半张没卖完的符纸。" },
          { narr: "一不露财，二不结仇，三……他说漏了一件——这世道，心善的人活不长。" },
          { sfx: "backstab" },
          { move: "hanli", to: 4, ms: 800 },
          { say: "hanli", text: "他叫万小山。记住这个名字——到了底下，好报路引。" },
          { cgOut: true },
        ],
      }},
    ],
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { narr: "你还没把丹收进贴身袋，殿外一声冷笑。一个锦袍青年大步而入，身后跟着几名弟子。" },
          { say: "luyunfeng", tone: "倨傲", text: "好啊——一个四灵根的杂役坯子，也配领筑基丹？这丹给你是浪费，识相的，自己交出来。" },
          { narr: "陆云风……太南小会上，被我抢先换走法宝残片的那位。好记性。" },
          { narr: "吴师叔脸色一沉，往你身前一站。" },
          ...
          { cam: "shake", px: 4 },
          { sfx: "hit" },
          { narr: "吴师叔还要开口，叶师叔一道眼风扫过去，筑基中期的灵压无声铺开。吴师叔的手攥紧又松开——他只是筑基初期。" },
          { say: "wushishu", tone: "低声，几乎是从牙缝里", text: "叶师叔，这不合谷例……" },
          { say: "yeshishu", text: "老夫说合，便合。" },
          { narr: "反抗？练气七层对筑基中期。这就是修仙界——七玄门换了个更大的壳子罢了。但这一幕，我记下了。" },
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { narr: "你把症候、根由、救法一一道来，又顺手指出旁边两畦的早衰之相。老者的眉毛挑了挑，上下重新打量你。" },
          { say: "mashibo", tone: "哼了一声，语气却松了", text: "……倒不是个棒槌。行，西头那排青元参苗归你管——那是老夫的心尖子，照料好了，例钱翻倍。" },
          { sfx: "page" },
          { narr: "他扔给你一本翻烂了的《百草谱》，转身就走，走两步又顿住，没回头。" },
          { say: "mashibo", tone: "含糊地", text: "夜里霜重，参苗记得盖草帘。……例钱在房梁上，自己取。" },
   ...
   * ============================================================ */
  {
    ...
    text: [
      ...
      { stage: {
        ...
        units: [
          { id: "hanli", art: "bt_hanli", pos: 1, name: "韩立", face: "r" },
          { id: "chenqiaoqian", art: "bt_chenqiaoqian", pos: 9, name: "陈巧倩", face: "l" },
          { id: "luyunfeng", art: "bt_luyunfeng", pos: 8, name: "陆云风", face: "l" },
        ],
        script: [
          { freeMove: true, hint: "隐去身形，循声摸过去……", trigger: { npc: "luyunfeng", radius: 3 } },
          { narr: "林间空地上，一个青衫女修被金色光索捆在树上，灵力被封，发髻散乱——是坊市里见过的陈家师姐，陈巧倩。" },
          { narr: "她对面站着的人，你也认得。锦袍，折扇——陆云风。" },
          { say: "luyunfeng", text: "巧倩，别怪我。红拂师叔的门下只收无牵无挂之人……你说，我一个有道侣的，怎么攀得上董师妹那条线？" },
          { say: "chenqiaoqian", text: "陆云风！结缘那日你说的话，你的道心就喂了狗——" },
          { say: "luyunfeng", text: "道心？我的道心就是筑基。你身上那两枚筑基丹，也一并留下吧——黄泉路上，用不着。" },
          { sfx: "sword" },
          { narr: "他扬手，一道剑光缓缓抵上她的咽喉。" },
          { narr: "为攀高枝杀道侣灭口……这种东西也配修仙。更要紧的是——他手里有两枚筑基丹。" },
          { narr: "出手，是杀人灭口的死局开端；不出手，眼睁睁看人死。……墨大夫、金光上人、杀万小山的散修——我什么时候怕过死局了。" },
          { sfx: "backstab" },
          { combat: "luyunfeng_fight", inheritPos: true },
        ],
      }},
    ],
    choices: [
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { narr: "树上的陈巧倩已被你解开。她抱着膝盖坐在地上，半晌，忽然低声开口。" },
          { say: "chenqiaoqian", tone: "声音很轻", text: "师弟……今日之事，你要杀我灭口吗？" },
          { narr: "你摇头。她看着你，眼睛在暮色里亮得吓人。" },
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { sfx: "chime" },
          { say: "nangongwan", emo: "cold", text: "诸位若是看过近三十年的灵药产数，就不会问这句话了。禁地灵气衰减，主药一茬比一茬薄——再按五年开，开到后头就是空山。" },
          { narr: "白衣广袖的年轻女修立在殿侧，眉目清艳，声音不高，满殿却静了下来。有人低声道：那是掩月宗的南宫婉，此番代宗门观礼。" },
          { narr: "掩月宗……天之骄女。传闻她筑基用了不到四年。" },
          { narr: "名额分派到百药园一脉时，管事的报上去三个名字，没有你。" },
          { cam: "pan", to: { x: -3, y: 0 }, ms: 800 },
  ...
  },
  {
    ...
    text: [
      ...
      "血色主药多生在中环以深。外环安稳，药也薄；越深，药越足——人也越凶。",
  ...
  },
  {
    ...
    text: [
      ...
      "狙杀者封岳——靠猎杀同门换资粮的亡命徒。他的靴子能让他快人一步……杀了他，那双靴子就是我的。",
    ],
    choices: [
  ...
  },
  {
    ...
    text: [
      ...
      "退？潭边的主药、它身上的角与鳞……还有这个压制了修为也敢进禁地的女人。今天没有退路，也不需要。",
    ],
    choices: [
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { sfx: "whiff" },
          { narr: "不好——妖兽临死的脏东西破了。屏息！……来不及了。" },
          { narr: "香气入肺，识海像被温水漫过。你最后的清明里，只看见她回头望来的那一眼——那双总是冷冷的眼睛，此刻雾蒙蒙的，像化开的月亮。" },
          { wait: 700 },
          { narr: "（血色的雾，遮住了潭边。）" },
          { wait: 500 },
          { narr: "——醒来时，天光已经换了颜色。" },
          { narr: "她背对着你坐在三步外，白衣整整齐齐，乌发一丝不乱，仿佛什么都没有发生。只有潭水知道发生过什么。" },
          { say: "nangongwan", emo: "cold", text: "墨蛟淫囊之毒，你我皆中，谁也怪不得谁。——今日之事，此生不得对第三人提起。" },
          { narr: "她的声音冷静得近乎残忍，说完便起身取材：割角、剥鳞、自蛟首中摄出元神。最后，她把一枚拳头大的暗色「内丹」抛了过来。" },
          { say: "nangongwan", text: "内丹归你，角鳞也归你。掩月宗要的元神，我已取了。两清。" },
          { narr: "你接住内丹，应了声「好」。她广袖一拂便要凌空而去——却在血雾边缘，停了一步。" },
          { say: "nangongwan", text: "……还没问你名字。" },
          { narr: "「韩立。」你说，「立碑的立。」" },
          { narr: "她背对着你，半晌没动。血色雾气里，你听见她极轻地重复了一遍。" },
          { bgm: "sorrow" },
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { cam: "zoom", scale: 1.08, ms: 600 },
          { say: "qiyunxiao", text: "墨蛟的料？啧——好东西，到了旁人手里是糟蹋。皮可裁帆、角可炼钩、鳞可衬骨。小兄弟，是要快、要狠，还是要稳？" },
          { say: "hanli", text: "都要。" },
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { narr: "可惜执法堂晚了一步。叶师叔越狱遁走，三日后，尸身在谷外百里的乱石滩上被发现——出手的是路过的散修雷万鹤，一击毙命。" },
  ...
  },
  {
    ...
    text: [
      ...
      { stage: {
        ...
        units: [
          { id: "hanli", art: "bt_hanli", pos: 2, name: "韩立", face: "r" },
          { id: "dongxuaner", art: "bt_dongxuaner", pos: 4, name: "董萱儿", face: "r" },
          { id: "zhanwangchan", art: "bt_wangchan", pos: 10, name: "战王蝉", face: "l" },
        ],
        script: [
          { fx: "burst", elem: "tu", n: 18 },
          { sfx: "landDown" },
          { cam: "shake", px: 8 },
          { narr: "妖氛冲天，堡墙轰然炸裂——魔道巨擘战王蝉破阵而出！甲胄如铁，双镰开阖，振翅之间裂石分风，正道修士成片倒下。" },
          { move: "zhanwangchan", to: 7, ms: 1200 },
          { say: "dongxuaner", text: "它的目标是堡心！挡不住它，今夜谁也活不成——韩立，你那柄破甲的钩子，该出鞘了！" },
          { narr: "诛它？这等魔道巨擘岂是今日的你能诛的。撑过它的杀势、活着退出燕家堡——这一战，只为这一个字：活。" },
          { combat: "zhanwangchan_fight", inheritPos: true },
        ],
      }},
    ],
    choices: [
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { sfx: "danger" },
          { narr: "堡外，七派会盟的执旗使早已等在那里。一面「征」字大旗压下来——凡今夜活着出堡的筑基修士，尽数编入魔道争锋的战阵，即刻开赴前线。" },
  ...
  },
  {
    ...
    text: [
      ...
      { stage: {
        ...
        units: [
          { id: "hanli", art: "bt_hanli", pos: 2, name: "韩立", face: "r" },
          { id: "lvtianmeng", art: "bt_lvtianmeng", pos: 5, name: "吕天蒙", face: "r" },
          { id: "xuanle", art: "bt_xuanle", pos: 6, name: "宣乐", face: "l" },
        ],
        script: [
          { sfx: "landDown" },
          { fx: "burst", elem: "tu", n: 16 },
          { cam: "shake", px: 8 },
          { narr: "一队人奉命深入矿洞清剿渗进来的魔物。行至深处，一声闷响——有人炸了矿！岩层轰然垮塌，烟尘里惨叫四起，整支小队转眼被冲散在塌方与黑暗之间。" },
          { fx: "flash", color: "#2a0810", alpha: 0.3, ms: 280 },
          { sfx: "backstab" },
          { move: "xuanle", to: 5, ms: 600 },
          { narr: "混乱中你瞥见一道身影贴上了吕天蒙的后背——是宣乐。他脸上那点浅笑终于咧开，一柄淬毒的匕首已抵住队官的命门。" },
          { say: "xuanle", text: "队官，得罪了。这矿脉底下的好东西，掩月宗惦记很久了……黑吃黑而已，乱矿里死个把人，谁查得清？" },
          { narr: "掩月宗的阴手！平日扮作征卒敛息匿形，专挑这种乱局对自己人下手——这一路阴诡敌型，你还是头一回正面撞上。" },
          { narr: "吕天蒙吐着血，用尽最后力气将一截青铜短尺塞进你手里。" },
          { say: "lvtianmeng", text: "平天尺……替我，带出去。这条毒蛇，别……别让他得逞——" },
          { wait: 500 },
          { narr: "话没说完，人就凉了。宣乐的匕首已转向了你。识破了他的偷袭，退无可退——这一战，替死去的队官，讨回那一刀！" },
          { combat: "xuanle_fight", inheritPos: true },
        ],
      }},
    ],
    onArrive(s) {
  ...
  },
  {
    ...
    text: [
      ...
      { stage: {
        ...
        units: [
          { id: "hanli", art: "bt_hanli", pos: 2, name: "韩立", face: "r" },
          { id: "xueyu_zhizhu", art: "bt_xueyu_zhizhu", pos: 10, name: "血玉蜘蛛", face: "l" },
        ],
        script: [
          { sfx: "farRoar" },
          { fx: "flash", color: "#7a0a18", alpha: 0.4, ms: 300 },
          { fx: "burst", at: 10, elem: "tu", n: 18 },
          { cam: "shake", px: 10 },
          { narr: "血光一闪，一头通体血玉甲壳、八足如戟的巨妖自封印中挣出——四级蛛妖，血玉蜘蛛！封印松脱，它狂化在即，猩红的复眼里只剩噬人的疯狂。" },
          { move: "xueyu_zhizhu", to: 8, ms: 800 },
          { sfx: "landDown" },
          { cam: "shake", px: 6 },
          { narr: "四级妖，气息比寻常筑基还凶悍几分。可它那一身岩穴血玉，是土煞之质——你这身木行道基，正克它。狭路相逢，避无可避：杀了它，或被它吞了。" },
          { combat: "xueyu_zhizhu_fight", inheritPos: true },
        ],
      }},
    ],
    onArrive(s) {
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { say: "chenqiaoqian", emo: "sad", tone: "话放得极轻，怕惊散了什么", text: "我听闻黑风岭矿场守备死了大半，名册上又迟迟不见你的牌号……我还当，这一面是再见不着了。" },
          { narr: "她到底没把那句话说尽。当着满营征卒，押队的女修把翻涌的心绪压回那身清冷底下，只是看你的眼神，比黄枫谷那年要深得多。" },
          { narr: "她记得。坊市归途那一夜你拼死护下的人，终究没忘。那枚没喂下去的忘尘丹，让她把这一点记挂，一路揣到了这刀山火海的前线。" },
          { say: "hanli", emo: "cold", tone: "拱手，话说得淡", text: "巧倩师姐。让师姐挂心了。矿洞塌方，侥幸捡回条命——命大而已，当不得什么。" },
          { narr: "你刻意把话头压平。伪灵根走到今日，全凭不与人深交、不教人看清深浅——这魔道前线更是如此。她待你的这份好，你领；可这份情，你给不起，也不敢接。" },
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { narr: "他身后还立着三人：稳重持珠的宋蒙、叉腰啐声的钟卫娘，与一个年纪轻轻、嗷嗷好斗的武炫。" },
          { say: "zhongweiniang", tone: "心直口快", text: "伪灵根？我只问你打不打得过魔修。打得过，就是好同袍——打不过，宋师兄给你收尸！" },
  ...
  },
  {
    ...
    text: [
      ...
      { stage: {
        ...
        units: [
          { id: "hanli", art: "bt_hanli", pos: 2, name: "韩立", face: "r" },
          { id: "wuxuan", art: "bt_wuxuan", pos: 4, name: "武炫", face: "r" },
          { id: "moxiu_lead", art: "bt_moxiu", pos: 12, name: "魔修领队", face: "l" },
          { id: "moxiu1", art: "bt_moxiu", pos: 11, name: "魔修喽啰", face: "l" },
          { id: "moxiu2", art: "bt_moxiu", pos: 13, name: "魔修喽啰", face: "l" },
        ],
        script: [
          { sfx: "danger" },
          { move: "moxiu_lead", to: 10, ms: 1500 },
          { move: "moxiu1", to: 9, ms: 1500 },
          { move: "moxiu2", to: 11, ms: 1500 },
          { narr: "轮到你与武炫一队出哨。焦土上腥风阵阵，没走多远，前方残垣后忽地窜出三道人影——黑袍束发、煞气缭绕，是黑煞教外围的魔修游猎小队。" },
          { narr: "为首一个手提血煞长镰，脚边半拖着两具被阴纹符箓驱动的尸傀；身后两名喽啰呈犄角散开，竟隐隐结成一张小阵。" },
          { say: "wuxuan", text: "韩兄留神——这帮魔修惯走群阵，领队在，那俩喽啰就缠成一团网。" },
          { say: "wuxuan", text: "可领队一倒，剩下的就是各自逃命的乌合之众。擒贼先擒王——先斩那提镰子的！" },
          { narr: "你头一回正面会魔修的「群阵」。那领队行的是土煞尸气，正撞你木行道基的相克——啃得动。心念电转间，你已看准了破阵的眼：那柄血煞镰后头那张脸。" },
          { combat: "moxiu_patrol_fight", inheritPos: true },
        ],
      }},
    ],
    choices: [
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { sfx: "pick" },
          { narr: `她"嗯"了一声，伸手从火堆边的瓦罐里捻起一枚炒得焦香的栗子，指尖一弹——那栗子不偏不倚，正打在你胸口，又落进你掌里，兀自温热。` },
          { say: "nangongwan", emo: "cold", tone: "语气淡得听不出情绪", text: "听说……前几日有位押丹药的黄枫谷女修，在你这队里停了好一会儿。盯着你看的。" },
          { say: "nangongwan", tone: "拨了拨火，没看你", text: "前线人多眼杂。韩师弟的『艳福』，倒比你那点修为来得显眼。" },
          { narr: "你被这没头没脑的一句问得怔住，老老实实想了半天，只当她是提点你前线少惹是非，便郑重应道——" },
          { say: "hanli", emo: "cold", text: "道友放心。在下伪灵根之身，一向谨言慎行，绝不敢因私废了军务。" },
          { narr: "南宫婉拨火的手一顿，侧过脸深深看了你一眼，那眼神里似有千言，最终只化作一声极轻的嗤笑，眉眼间的清冷竟柔和了一瞬。" },
  ...
  },
  {
    ...
    text: [
      ...
      { stage: {
        ...
        units: [
          { id: "hanli", art: "bt_hanli", pos: 2, name: "韩立", face: "r" },
          { id: "tieluo", art: "bt_tieluo", pos: 10, name: "铁罗", face: "l" },
        ],
        script: [
          { sfx: "farRoar" },
          { fx: "flash", color: "#7a0a18", alpha: 0.4, ms: 320 },
          { fx: "burst", at: 10, elem: "huo", n: 18 },
          { cam: "shake", px: 8 },
          { narr: "血雾翻涌，一道缠满血煞赤焰的身影自池畔升起——黑煞教的血侍，铁罗。他便是这桩连环失踪案的爪牙。" },
          { move: "tieluo", to: 8, ms: 600 },
          { say: "tieluo", text: "黑煞教的事，也是你一个外来户能管的？既然撞进来了……就留下，一并入池吧。" },
          { narr: "蒙山五友散开扑向血池、七手八脚地抢救池中活人；缠住铁罗这条恶犬的活儿，落在你身上。他行火，木生火——你这身木行道基这回占不到相克的便宜，是场硬仗。逼他现出黑煞教的形迹、断他一臂，再说！" },
          { combat: "tieluo_fight", inheritPos: true },
        ],
      }},
    ],
    onArrive(s) {
  ...
  },
  {
    ...
    text: [
      ...
      { stage: {
        ...
        units: [
          { id: "hanli", art: "bt_hanli", pos: 2, name: "韩立", face: "r" },
          { id: "tieluo_mao", art: "bt_tieluo_mao", pos: 10, name: "血茧铁罗", face: "l" },
        ],
        script: [
          { sfx: "farRoar" },
          { fx: "burst", at: 10, elem: "huo", n: 20 },
          { cam: "shake", px: 10 },
          { narr: "那枚暗红血茧在血雾里剧烈搏动、茧丝翻卷暴涨——只听「噗」的一声闷响，茧壳自内炸裂，一头独臂、血肉外露的畸变之物从中挣出。" },
          { narr: "断了一臂的铁罗，竟以血侍秘术「化血茧」把残余血煞尽数榨入这具躯壳：血气暴涨、痛觉尽失，只剩仅存的一条手臂暴长狰狞、化作滴血巨爪。他发须皆赤、双目猩红如血珠暴突，再不似先前那阴诡的模样。" },
          { move: "tieluo_mao", to: 7, ms: 500 },
          { say: "tieluo_mao", tone: "声音嘶哑扭曲、近乎癫狂", text: "断我一臂……好，好得很！黑煞教的血侍，便是化成一摊烂肉，也要把你拖进这血池！" },
          { narr: "这是头濒死搏命的凶兽——蜕了皮甲、血肉外露（破甲更易），可血气狂涌、招式更重更猛。他仍行火，木生火，你那身木行道基依旧占不到相克的便宜。只能凭底牌与硬功，把这具血茧，彻底打垮！" },
          { combat: "tieluo2_fight", inheritPos: true },
        ],
      }},
    ],
    onArrive(s) {
  ...
  },
  {
    ...
    text: [
      ...
      { stage: {
        ...
        units: [
          { id: "hanli", art: "bt_hanli", pos: 2, name: "韩立", face: "r" },
          { id: "mocaihuan", art: "mocaihuan", pos: 3, name: "墨彩环", face: "r" },
          { id: "wuse_menzhu", art: "bt_wuse", pos: 10, name: "王管事", face: "l" },
        ],
        script: [
          { sfx: "farRoar" },
          ...
          { fx: "burst", elem: "tu", n: 16 },
          { cam: "shake", px: 8 },
          { say: "wuse_menzhu", tone: "嘶哑的、再不似人声", text: "墨家那点旧账……也值得你们千里寻来送死？黑煞教供养的煞体，岂是尔等撼得动的！" },
          { move: "wuse_menzhu", to: 8, ms: 600 },
          { narr: "他行土，你那身木行道基，正克他。妖化厚甲虽然刀剑难透，可凭木克土的相克之利与底牌，能把这桩压了墨彩环半生的血债，今日了结。墨彩环立在你身侧，握剑的手在抖，眼里却是十年磨一日的决绝。" },
          { combat: "wuse_fight", inheritPos: true },
        ],
      }},
    ],
    onArrive(s) {
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { say: "mocaihuan", emo: "smile", tone: "她顿了顿，眉眼弯起来", text: "我爹墨居仁，是个郎中。当年墨府上下，靠他一双手不知活了多少人。我想……把医馆重新支起来。这京城繁华，从来不缺杀人的刀，缺的是救人的手。" },
    ...
    text: [
      ...
      { stage: {
        ...
        units: [
          ...
          { id: "songmeng", art: "bt_songmeng", pos: 1, name: "宋蒙", face: "r" },
          { id: "zhongweiniang", art: "bt_zhongweiniang", pos: 4, name: "钟卫娘", face: "r" },
          { id: "xueshi1", art: "bt_xueshi", pos: 12, name: "血侍", face: "l" },
          { id: "xueshi2", art: "bt_xueshi", pos: 11, name: "血侍", face: "l" },
          { id: "xueshi3", art: "bt_xueshi", pos: 13, name: "血侍", face: "l" },
        ],
        script: [
          { sfx: "farClash" },
          { fx: "burst", elem: "huo", n: 14 },
          { cam: "shake", px: 10 },
          { narr: "皇宫大门在九道灵光合击下轰然洞开。门后，是黑压压一片缠着血煞赤焰的血侍——黑煞教豢养的死士，闻到生人气息，嘶吼着扑了上来。" },
          { move: "xueshi1", to: 9, ms: 1200 },
          { move: "xueshi2", to: 8, ms: 1200 },
          { move: "xueshi3", to: 10, ms: 1200 },
          { say: "liujing", text: "韩师弟，三组分头缠住血侍——莫要恋战！杀开一条道，直取贼首！" },
          { narr: "你与刘靖一组当锋、宋蒙持珠护中、钟卫娘游火收割，三组同袍背靠背列开阵势。这是九筑基夜闯皇城的开幕，也是你头一回以『群阵』之姿、与三组同袍同场冲杀——战中可下简令，让同袍交叉支援、护住彼此侧翼。" },
          { combat: "santuan_fight", inheritPos: true },
        ],
      }},
    ],
    choices: [
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { narr: "众人一时愕然：贼首竟是这位看似无害的一国之君？刘靖却不为所动——他长身而立，腰间那道祖传真宝『凤凰符』，已悄然燃起一缕赤金灵光。" },
          { say: "liujing", tone: "他一声清叱，凤凰符腾空而起", text: "魔道役尸、以国炼煞，便是天王老子也该诛！家传凤凰符在此——黑煞教的血侍，今日休想再害一人！" },
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { sfx: "farRoar" },
          { fx: "burst", at: 6, elem: "huo", n: 16 },
          { cam: "shake", px: 10 },
          { narr: "假丹之威一压，满殿同袍如坠冰窟。宋蒙的重元珠被震得嗡嗡作响，钟卫娘一口气血上涌，连你也只觉那身木行道基被压得几乎喘不过气。" },
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { narr: "竹海缠足、九天真火倒灌、镜影分身、渊薮心魔、黄沙陷脚……五行之力逐息反噬，那不可一世的假丹之威，竟被一寸寸地压了下去。胥王第一次露出了惊怒之色。" },
  ...
  // ——【Act1·寻魂夺剑·其一】御灵宗夺舍者驱兽拦路：金背妖螂险战（fieldCycle 颠倒五行阵图反制）——
  {
    ...
    text: [
      ...
      { stage: {
        ...
        units: [
          { id: "hanli", art: "bt_hanli", pos: 2, name: "韩立", face: "r" },
          { id: "duoshe_zhe", art: "bt_wuren", pos: 8, name: "御灵宗夺舍者", face: "l" },
          { id: "jinbei", art: "bt_baihu", pos: 10, name: "金背妖螂", face: "l" },
        ],
        script: [
          { cam: "zoom", scale: 1.05, ms: 800 },
          { say: "duoshe_zhe", tone: "cold", text: "「曲魂的气息，果然在你身上。识相的，把它交出来——本座还能留你个全尸。」" },
          { say: "hanli", emo: "cold", text: "「御灵宗的人……来得倒快。这缕曲魂，如今是我的底牌——想要，自己来取。」" },
          { fx: "lightning", at: 10, elem: "jin" },
          { narr: "那夺舍者冷哼一声，袖一挥——金背妖螂双镰一振，金鸣裂石，朝你扑来！" },
          { move: "jinbei", to: 6, ms: 800 },
          { sfx: "landDown" },
          { cam: "shake", px: 6 },
          { narr: "金克木、甲坚镰利——硬碰硬讨不了好。祭出颠倒五行阵图，以阵法逐回合反制金锋，曲魂当先迎战！" },
          { combat: "jinbei_fight", inheritPos: true },
        ],
      }},
    ],
  ...
  // ——【Act1·寻魂夺剑·其二】御灵宗夺舍者·夺剑（waves 二阶段；胜得绿煌剑+奇虫榜玉简）——
  {
    ...
    text: [
      ...
      { stage: {
        ...
        units: [
          { id: "hanli", art: "bt_hanli", pos: 2, name: "韩立", face: "r" },
          { id: "duoshe", art: "bt_sanxiu", pos: 10, name: "夺舍者", face: "l" },
        ],
        script: [
          { cam: "zoom", scale: 1.16, ms: 240 },
          { sfx: "sword" },
          { fx: "swordRing", elem: "mu" },
          { say: "duoshe", tone: "angry", text: "「区区筑基，也敢坏本座的事！这绿煌剑乃我本命之宝，今日便叫你死在它下！」" },
          { narr: "你心头雪亮：他神魂虽是结丹，强占的这具躯壳却催不全本命真元——战力被生生压在筑基一档。这柄绿煌剑，今日志在必得。" },
          { say: "hanli", emo: "cold", tone: "low", text: "「催不全的本命之力……那便是你的死穴。曲魂——上！」" },
          { fx: "burst", at: 10, elem: "mu", n: 14 },
          { move: "duoshe", to: 7, ms: 700 },
          { cam: "shake", px: 6 },
          { narr: "绿煌剑剑气森森，直取你面门——曲魂血刃横身挡下第一击，假丹之威与结丹本命硬撼，赤绿两色灵光在乱石坡上炸开！" },
          { combat: "duoshe_fight", inheritPos: true },
        ],
      }},
    ],
    onArrive(s) { s.location = "jiayuan_city"; },
  ...
  // ——【Act2·金鼓原崩盘·其一】群战（sides[]：李化元/南宫婉并肩 vs 黑煞教残众）——
  {
    ...
    text: [
      ...
      { stage: {
        ...
        units: [
          { id: "hanli", art: "bt_hanli", pos: 2, name: "韩立", face: "r" },
          { id: "lihuayuan", art: "lihuayuan", pos: 3, name: "李化元", face: "r" },
          { id: "nangongwan", art: "bt_nangongwan", pos: 4, name: "南宫婉", face: "r" },
          { id: "moxiu_lead", art: "bt_moxiu", pos: 12, name: "魔修领队", face: "l" },
        ],
        script: [
          { say: "lihuayuan", tone: "stern", text: "「韩立！你来得正好——先斩那魔修领队，群势自溃！曲魂护住中路！」" },
          { say: "nangongwan", tone: "cold", text: "「我掠左翼。韩立，你我合力——擒贼先擒王。」" },
          { move: "moxiu_lead", to: 9, ms: 1000 },
          { sfx: "danger" },
          { cam: "shake", px: 6 },
          { narr: "魔修领队率残众压上，煞气如潮——与李化元、南宫婉并肩冲杀，先斩领队、撕开缺口！" },
          { combat: "jingu_fight", inheritPos: true },
        ],
      }},
    ],
    onArrive(s) {
  ...
  // ——【Act2·金鼓原崩盘·其二】护山大阵·守阵（objective:survive；撑到李化元燃命布阵）——
  {
    ...
    text: [
      ...
      { stage: {
        ...
        W: 12,
        units: [
          { id: "hanli", art: "bt_hanli", pos: 3, name: "韩立", face: "l" },
          { id: "lihuayuan", art: "lihuayuan", pos: 6, name: "李化元", face: "l" },
          { id: "moxiu_wave", art: "bt_moxiu", pos: 11, name: "魔修潮", face: "l" },
        ],
        script: [
          { fx: "burst", at: 6, elem: "tu", n: 12 },
          { say: "hanli", emo: "cold", tone: "low", text: "「李前辈——！……好。曲魂，封住阵口，一个都别放进来！」" },
          { move: "moxiu_wave", to: 8, ms: 1200 },
          { sfx: "danger" },
          { cam: "shake", px: 8 },
          { narr: "魔潮如决堤之水涌来——死守阵脚六息，拖到护山大阵布成即可，不必胜！" },
          { combat: "hushan_fight", inheritPos: true },
        ],
      }},
    ],
  ...
  // ——【Act4·再别天南·其一】三人护道战（objective:survive；南宫婉/陈巧倩护道）——
  {
    ...
    text: [
      ...
      { stage: {
        ...
        units: [
          { id: "hanli", art: "bt_hanli", pos: 2, name: "韩立", face: "r" },
          { id: "nangongwan", art: "bt_nangongwan", pos: 3, name: "南宫婉", face: "r" },
          { id: "chenqiaoqian", art: "chenqiaoqian", pos: 4, name: "陈巧倩", face: "r" },
          { id: "pursuer", art: "bt_moxiu", pos: 11, name: "魔道追兵", face: "l" },
        ],
        script: [
          { say: "nangongwan", tone: "cold", text: "「韩立，护住退路——这一波追兵，我与巧倩替你拦下。」" },
          { say: "chenqiaoqian", tone: "anxious", text: "「韩师弟当心！往矿洞去的路，绝不能断！」" },
          { move: "pursuer", to: 8, ms: 1000 },
          { sfx: "danger" },
          { cam: "shake", px: 6 },
          { narr: "魔道追兵如附骨之疽——三人结阵护道，撑住这一波，护住身后那条退往越国矿洞的退路！" },
          { combat: "hudao_fight", inheritPos: true },
        ],
      }},
    ],
    ...
    text: [
      ...
      { stage: {
        ...
        units: [
          ...
          { id: "pursuer2", art: "bt_moxiu", pos: 11, name: "追兵", face: "l" },
        ],
        script: [
          { cam: "shake", px: 8 },
          { narr: "话音未落，追兵已踏碎洞口、潮水般涌入。曲魂血刃横身拦在阵前——只剩这最后六息了。" },
          { move: "pursuer2", to: 7, ms: 1000 },
          { sfx: "danger" },
          { cam: "shake", px: 6 },
          { narr: "死守隘口六息——待大挪移令催动古阵，便能一步踏出天南！" },
          { combat: "kuangdong_fight", inheritPos: true },
        ],
      }},
    ],
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { wait: 600 },
          { narr: "海天一色，无边无际。远处星罗棋布般散着大大小小的岛屿，天际线上妖氛弥漫、隐有庞然之物翻涌的气息。这片汪洋，比你见过的任何天地都更辽阔、也更凶险。" },
  ...
  // —— 第一幕①·落海·低阶妖兽遭遇（fieldCycle 海域相位·神识强/修为弱反差·凡人味开局）——
  {
    ...
    text: [
      ...
      { stage: {
        ...
        units: [
          { id: "hanli", art: "bt_hanli", pos: 2, name: "韩立", face: "r" },
          { id: "yaoshou", art: "bt_waihai", pos: 10, name: "海中妖兽", face: "l" },
        ],
        script: [
          { move: "yaoshou", to: 7, ms: 900 },
          { sfx: "splash" },
          { cam: "shake", px: 5 },
          { narr: "举目皆是陌生的妖海。身后是再回不去的天南，身前是吉凶未卜的星海万里——可活下去，永远是第一位的。" },
          { combat: "starsea_yaoshou_fight", inheritPos: true },
        ],
      }},
    ],
    onArrive(s) {
  ...
  // —— 第一幕③·镇妖台擂台 1v1（演示「藏拙」机制·炼气五层假苦战胜八层·猥琐发育）——
  {
    ...
    text: [
      ...
      { stage: {
        ...
        units: [
          { id: "hanli", art: "bt_hanli", pos: 2, name: "韩立", face: "r" },
          { id: "leitai_dashi", art: "bt_wuren", pos: 8, name: "擂台打手", face: "l" },
        ],
        script: [
          { narr: "你故意只引动炼气五层的灵力，把一身真元死死压在丹田里，与那汉子缠斗得险象环生——格挡时踉跄半步，还击时似强弩之末，引得台下一阵阵惊呼。" },
          { move: "leitai_dashi", to: 5, ms: 600 },
          { fx: "burst", at: 5, elem: "jin", n: 10 },
          { sfx: "hit" },
          { cam: "shake", px: 4 },
          { narr: "凡人堆里摸爬滚打出来的本事，从不只是斗法——更是「让人小看你」的火候。这一身狼狈，演得比那汉子的灵光还要费神。" },
          { combat: "starsea_leitai_fight", inheritPos: true },
        ],
      }},
    ],
    onArrive(s) {
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { narr: "你心中一动：降尘丹，正是叩开结丹之门的一线契机。当下与文樯约定，同往六连殿报名。" },
  ...
  // —— 第二幕③·极限斩杀婴鲤兽（sides[冯三娘+曲魂]＋waves[婴鲤兽幼体→困兽暴走]＋fieldCycle 水罡＋越阶斩杀）——
  {
    ...
    text: [
      ...
      { stage: {
        ...
        units: [
          { id: "hanli", art: "bt_hanli", pos: 2, name: "韩立", face: "r" },
          { id: "yingli", art: "bt_yingli", pos: 10, name: "婴鲤兽", face: "l" },
        ],
        script: [
          { narr: "你与曲魂一直按兵不动，只待这一刻——巨兽力竭、阵图收束的须臾之隙。黑煞血刃与你的剑光自两翼同时没入它的命门！" },
          { move: "yingli", to: 6, ms: 800 },
          { fx: "burst", at: 6, elem: "shui", n: 14 },
          { cam: "shake", px: 8 },
          { narr: "越级而战，从不靠硬碰硬。耗它、困它、算准那一线之机——这，才是凡人韩立的杀法。" },
          { combat: "starsea_yingli_fight", inheritPos: true },
        ],
      }},
    ],
    onArrive(s) {
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { narr: "那黑袍人——逆星盟乌丑——立于裂口之上，狞笑出声；他身侧，白衣风希负手而立；六连殿一名长老竟也反水相助，三道身影合力撕开了封印的最后一线。" },
          { say: "wuchou", tone: "cold", text: "「镇压了百年的旧主，也该出来透透气了。诸位，便拿这一场镇妖大典，给它陪葬罢！」" },
          { fx: "lightning", at: 7, elem: "jin" },
          { sfx: "thunder" },
          { cam: "zoom", scale: 1.2, ms: 600 },
          { narr: "封印之下，一声撼动海天的鹏唳炸响——一头通体雷光、双翅垂天的神禽冲天而起！上代妖兽之王，十级雷鹏！被星宫双圣镇压在镇妖台下整整百年的它，此刻睥睨众生，眸中尽是百年屈辱化成的滔天恨意。" },
          { narr: "「噫——！百年之囚，今日尽数还来！」雷鹏的怒鸣撼动海天。" },
          { fx: "lightning", at: 3, elem: "jin" },
          { fx: "lightning", at: 11, elem: "jin" },
          { sfx: "thunder" },
          { cam: "shake", px: 10 },
          { narr: "疾雷双翅一振，雷罡横扫，看台轰然崩塌；它一爪踏碎了镇压自己百年的星宫双圣石像，电芒过处，修士成片殒落。镇妖大典的盛景，顷刻化作修罗炼狱。同一刻，台心裂口轰然洞开——内外星海的通道，竟被一并打通了！" },
          { wait: 500 },
          { narr: "便在这屠戮无人能挡之际，那位白衣「大善人」风希终于动了。" },
          { say: "fengxi", tone: "low", text: "「上代之王又如何？这身雷骨、这对疾雷双翅……正是我炼制风雷翅的绝佳之材。莫怪。」" },
          { fx: "burst", at: 7, elem: "jin", n: 24 },
          { sfx: "thunder" },
  ...
  // —— 第二幕⑥·妙音门主殉难·救小紫灵·斩逆星盟古长老脱身（objective:survive 护送逃亡＋精英战）——
  {
    ...
    text: [
      ...
      { stage: {
        ...
        units: [
          { id: "hanli", art: "bt_hanli", pos: 2, name: "韩立", face: "r" },
          { id: "guzhanglao", art: "bt_guzhanglao", pos: 10, name: "古长老", face: "l" },
        ],
        script: [
          { narr: "怀中是一条托付给你的性命。护住她、杀出去——曲魂在侧，这一程逃亡，你不会孤身。" },
          { move: "guzhanglao", to: 7, ms: 700 },
          { fx: "burst", at: 7, elem: "jin", n: 12 },
          { sfx: "danger" },
          { cam: "shake", px: 6 },
          { narr: "逆星盟古长老假丹之威压顶，血遁追命之术拦住去路——护住紫灵，斩长老，杀出重围！" },
          { combat: "starsea_jiuziling_fight", inheritPos: true },
        ],
      }},
    ],
    onArrive(s) {
  ...
  // —— 第三幕③·外星海致富·霓裳草引妖·噬金虫群猎杀（FIGHT·妖丹硬通货）——
  {
    ...
    text: [
      ...
      { stage: {
        ...
        units: [
          { id: "hanli", art: "bt_hanli", pos: 2, name: "韩立", face: "r" },
          { id: "haiyao", art: "bt_waihai", pos: 10, name: "中阶海妖", face: "l" },
        ],
        script: [
          { fx: "burst", at: 10, elem: "jin", n: 16 },
          { sfx: "splash" },
          { narr: "掌心金芒暴起，噬金虫群如金云扑出。曲魂黑刃自侧翼并上——困而后杀，剖丹取财，星海的第一桶金，就在这一战。" },
          { move: "haiyao", to: 6, ms: 800 },
          { cam: "shake", px: 6 },
          { narr: "霓裳草的甜腻花气漫开，妖氛里海妖循香扑来——噬金虫四用法实战，困而后杀！" },
          { combat: "starsea_waihai_fight", inheritPos: true },
        ],
      }},
    ],
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { sfx: "cast" },
          { narr: "更要紧的是神识。二十载闭关加这一程外海历练，你将叶师叔遗下的《大衍诀》参研至三层——神识如臂使指、淬炼大成，方堪驾驭结丹之劫的反噬。" },
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { say: "hanli", emo: "pain", tone: "low", text: "「唔——！心魔……结丹的心魔，竟这般难缠！」" },
    ...
    text: [
      ...
      { stage: {
        ...
        script: [
          ...
          { sfx: "thunder" },
          { narr: "心魔伏、真元聚，丹田之内，盈满百窍的灵力被你反复压炼、层层凝散——终于，「噗」的一声轻响，一枚温润生光的金丹，在丹田里凝成了。" },
          { fx: "burst", at: 5, elem: "jin", n: 20 },
          { sfx: "success" },
