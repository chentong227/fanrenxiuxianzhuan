...
const STORY = [
   ...
   * ============================================================ */
  {
    ...
    text(s) {
      ...
      t.push(
        { say: "李化元", tone: "cold", text: "你筑基了，便是谷中战力。燕家这场『大会』水浑得很，与其日后被人推上去送死，不如老夫先把你这条命，用在该用的地方——去，替谷里看看那潭水有多深。" },
  ...
  },
  {
    ...
    text(s) {
      const t = [
        ...
        { say: "董萱儿", tone: "cold", text: "伪灵根能筑基，倒是稀奇。鬼灵门的人已经进了堡——那位借医病联姻入门的『王少主』，红拂门档册上可不是善类。活着出了这堡，再论你够不够格同我说话。" },
      ];
      // 钩子：杀陆云风 → 对董萱儿有额外内心
    ...
    onArrive(s) {
      ...
      Engine.meetNpc("dongxuaner", "红拂门下名门之后——陆云风当年为攀附她而痛下杀手；燕家堡血夜中与你并肩杀出。");
    ...
    choices(s) {
      ...
      if (n < 3) {
        ...
        mk("dong", "寻董萱儿——打探王蝉的路数", "互斥·得弱点情报（决战伤害+8%）", () => {
          Engine.writeLedger("yanjia_scout_dong", "向董萱儿打探王蝉路数——血遁突袭之后气门微滞，红拂门档册里记得明白");
          return { text: "董萱儿斜了你一眼，到底还是开了口：「红拂门档册记着——鬼灵门那位少主修的是《血灵大法》，血遁突袭之后气门微滞、有半息破绽。接得住，就是你的机会。」", kind: "good" };
        });
