...
const STORY = [
  ...
  // —— 节点 4-2·红尘小故事·棋友坐化（凡人小故事·收束高潮·数十年棋友·遗书·韩立顿悟）——
  ...
  // —— 节点 4-4·红尘劫·渡过（锚⑦收口·30年弹指·侧重3选1·Build三路）——
  {
    ...
    title: "红尘劫 · 渡过",
    objTitle: "三十年 · 一朝悟道",
    objHint: "青竹小轩开了三十年。生老病死、悲欢离合，你都看在眼里、记在心上。某个寻常的午后，你忽然心念通明——大衍诀第三层，成了。",
    text: [
      { scene: "青竹小轩 · 三十年后" },
      ...
      { fx: "burst", at: "center", elem: "jin", ms: 420 },
      { sfx: "success" },
      { say: "韩立", emo: "joy", tone: "low", text: "「原来如此……大衍诀第三层，要的不是闭门苦参，是这三十年的红尘。生老病死，因缘聚合，世间纷繁，皆有其意；迷之则轮回苦，悟之则天地宽——神识，圆满了。」" },
    ...
    onArrive(s) {
      ...
      Engine.writeLedger("xh_hongchen", "红尘劫渡过·30年入世修心——青竹小轩看尽红尘众生，一朝心念通明，大衍诀第三层大成（神识圆满·足驭72飞剑）。");
