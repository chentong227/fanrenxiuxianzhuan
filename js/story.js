...
const STORY = [
  ...
  // —— 节点 4-1·红尘小故事·情侣定情符（凡人小故事①·帮/不帮·心境）——
  {
    ...
    text: [
      ...
      { aside: "仙凡之隔，最是无解。你看着那姑娘强撑的笑脸，恍惚想起嘉元城里那个再也回不去的身影——墨彩环。当年若你早一步、或晚一步，是不是也会是这般光景？" },
    ],
    ...
    choices: [
      {
        ...
        effect(s) {
          ...
          Engine.writeLedger("hongchen_helped_couple", "红尘劫·仙凡一对求驻颜符——你赠了符，却实言相告：凡人的寿数仙符也续不得，劝他莫负眼下相守的光阴。仙凡之隔，照见自己与墨彩环那段回不去的错过。");
          return { text: "你画了道安神驻颜的浅符递过去，却没瞒他：「符能护她安康，却扳不动凡人寿数。仙凡一途，最难两全——能守的光阴，莫负了。」那修士眼圈一红，重重点头。门外天光正好，你心里却空落落的，像替自己也补了一句迟到的话。", kind: "good" };
        },
        resolve: "advance",
      },
      {
        ...
        effect(s) {
          ...
          return { text: "你照实收了符钱，旁的一概不言——他人的姻缘，与你何干？那修士谢过，扶着姑娘出了门。望着那一前一后的身影，你莫名又想起墨彩环，心里到底空落了一下。", kind: "event" };
        },
        resolve: "advance",
      },
    ],
  ...
  // —— 节点 4-2·红尘小故事·老者对弈（凡人小故事·收束高潮·冲结丹必死关·悟生死）——
  // 触发序改为第三个（情侣→小龙→老者），老者悟生死紧接「渡过」节点的一朝悟道。
  {
    id: "xh_a3_hc_elder",
    ...
    title: "青竹小轩 · 对弈的老者",
    objTitle: "红尘 · 生死一局",
    objHint: "一位筑基后期的老修士是小轩常客，总来与你手谈。他寿元将尽，执意要闯结丹的必死关——成则再活数百年，败则当场坐化。闯关前，他要与你下完最后一局棋。",
    text: [
      { scene: "青竹小轩 · 棋枰前" },
      "一位白须老者是小轩的常客——筑基后期的修为，寿元却已到了尽头。这些日子，他总来与你手谈一局。",
      { say: "老者", emo: "calm", text: "「老夫这把年纪，结丹的必死关，是非闯不可了。成，再活数百年；败，便埋在这一关里。」" },
      "他落下一子，笑得坦然：「闯关之前，再与小友下完这一局罢。」",
      { aside: "你比谁都清楚——筑基后期冲结丹，十死无生。可那双眼里，竟没有半分惧色。" },
    ],
    ...
    choices: [
      {
        ...
        effect(s) {
          ...
          s.demon = Math.max(0, (s.demon || 0) - 6);
          // 悟道偈语为动漫红尘劫原文（用户提供）；老者临终对弈台词为契合意境的演绎。
          Engine.writeLedger("hongchen_helped_elder", "红尘劫·与寿尽老修士对弈一局、送他闯结丹必死关——老者坐化的同时，隔壁恰传来婴儿初啼。一生一死间，你悟透了红尘劫：生老病死，因缘聚合，世间纷繁，皆有其意。");
          return { text: "你陪他落完最后一子。老者抚掌大笑：「这一局，老夫输了棋，却赢了个痛快——生死如棋，落子无悔。」言罢起身迎关，灵光一闪，溘然坐化。\n\n几乎同一刻，隔壁院里传来婴儿呱呱坠地的啼哭。一生一死，撞在你心头——\n\n生老病死，因缘聚合，世间纷繁，皆有其意；迷之则轮回苦，悟之则天地宽。此乃红尘劫。（心境+8·心魔-6）", kind: "good" };
        },
        resolve: "advance",
      },
      {
        ...
        effect(s) {
          s.mood = Math.min(s.moodMax, (s.mood || 0) + 3);
          Engine.writeLedger("hongchen_helped_elder", "红尘劫·劝寿尽老者莫闯必死关、苟全余年——他却笑你『后生不懂』，仍坦然迎关坐化。生死之事，劝不得也拦不得，这一课你记下了。");
          return { text: "你劝他何必拿命去赌。老者只是摇头大笑：「小友后生，还不懂——苟延这残喘的几年，与那必死关里搏一线生机，于老夫又有何异？」他到底闯了关，灵光一闪坦然坐化。生死之事，原是劝不得、拦不得的。", kind: "event" };
        },
        resolve: "advance",
      },
    ],
  ...
  // —— 节点 4-3·红尘小故事·小龙（凡人小故事·有灵根少年混帮派半残·韩立救治·暗示小绿瓶已耗尽）——
  {
    id: "xh_a3_hc_bully",
    ...
    text: [
      ...
      { aside: "若那只小绿瓶还在，滴几滴灵液温养，这点伤、这条灵根，都能救得回来。可它早已尽数耗在催熟万年金雷竹上了。如今的你，反倒要像青牛镇的墨大夫当年那样，靠一身药理，一寸寸地拼。" },
    ],
  ...
  // —— 节点 4-4·红尘劫·渡过（锚⑦收口·24年弹指·侧重3选1·Build三路）——
  {
    ...
    text: [
      ...
      "二十四年，弹指而过。仙凡情侣的离合、有灵根少年的浮沉、对弈老者的生死一局……青竹小轩的柜台后，你看尽了一茬又一茬的红尘众生。",
      "这一日午后，阳光斜照进小轩，你正给一个孩童画着平安符——忽然心念一通，万般尘缘如潮水般在识海里涨落又退去，澄澈如洗。",
      { fx: "burst", at: "center", elem: "jin", ms: 420 },
      { sfx: "success" },
      { say: "韩立", emo: "joy", tone: "low", text: "「原来如此……大衍诀第三层，要的不是闭门苦参，是这二十四年的红尘。生老病死，因缘聚合，世间纷繁，皆有其意；迷之则轮回苦，悟之则天地宽——神识，圆满了。」" },
    ...
    onArrive(s) {
      ...
      let hcEcho = 0;
      if (Engine.settleLedger("hongchen_helped_couple", "那对仙凡情侣后来如何，你已无从知晓——可当年柜前那一句『能守的光阴莫负了』，何尝不是说给当年错过墨彩环的自己听。仙凡之隔的那点意难平，红尘劫替你轻轻放下了")) hcEcho += 2;
      ...
      if (Engine.settleLedger("hongchen_helped_elder", "那位对弈迎关的老者坐化时隔壁初啼的婴孩，如今怕也满地乱跑了。生死一局、一啼一寂——『世间纷繁，皆有其意；迷之则轮回苦，悟之则天地宽』，这一句，是老者用一条命替你点透的红尘劫")) hcEcho += 4;
