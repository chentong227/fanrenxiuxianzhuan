...
const STORY = [
  ...
  // —— 第四幕②·集齐结丹资粮（雪灵水/天火液补齐＋大衍诀第四层蓄力·神识淬炼大成）——
  {
    ...
    text: [
      ...
      { sfx: "cast" },
      "更要紧的是神识。二十载闭关加这一程外海历练，你的神识已远超同侪——当年黄枫谷拾得的那卷《大衍诀》残卷，你终于翻得开第一页了。以其入门法门淬炼神识，如臂使指，方堪驾驭结丹之劫的反噬。",
  ...
  // —— 幕二⑤·毒计·万年灵乳（掺绿液时机抉择）——
  {
    ...
    text: [
      ...
      { shot: "pushIn", ms: 1300, scale: 1.12 },
      { aside: "杀机也在这句话里：收翅之后，「帮工」就没用了。你袖中捏着这些年一滴滴攒下的小半瓶绿液——催生万物，也能催得万年灵乳药力暴涨、涨到妖躯撑不住。掺，还是不掺？什么时候掺？" },
      { wait: 600 },
  ...
  // —— 幕四②·阴冥村生死战（绝灵凡人战斗首演）——
  {
    ...
    text: [
      { scene: "阴冥村 · 栅栏" },
      { amb: "night" },
      "入夜，荒原上亮起星星点点的灰白磷光——不是灯，是眼睛。",
      { amb: null },
      { shot: "shock", scale: 1.1, px: 7 },
      { sfx: "danger" },
      "长老嘶声敲响破锣：「灰蜮群！上栅栏！！」",
      { aside: "灰扑扑的异物贴地爬来，甲壳、利爪、成群结队。村里能打的男丁不足二十——你握紧了腰间那口许久没这样握过的剑。" },
      { shot: "focusRight" },
