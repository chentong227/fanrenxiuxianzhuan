...
const STORY = [
  ...
  },
  {
    ...
    text: [
      ...
      { say: "墨彩环", emo: "smile", tone: "她笑意微敛，声音轻下来", text: "这些年我刀口上舔血，谁都信不过，独自一个人撑着。可一见着你这张黑脸，我这心里，没来由地就踏实了。——黑小子，有你在，这桩血债，我敢去收了。" },
  ...
  },
  {
    ...
    text: [
      ...
      { say: "墨彩环", emo: "smile", tone: "她忽然认真起来，声音很轻，却字字落到实处", text: "黑小子，谢谢你。谢谢你，出现在我这微不足道的一生里。若没有你，我大约早死在追凶路上的某个夜里了，连块碑都不会有。如今我能堂堂正正地、为我自己活下去——这条命，有一半是你给的。" },
