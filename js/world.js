...
WORLD.locations = [
   ...
   *   过场地点，循剧情前行（非云游列表·由剧情 onArrive 落点）。考据见 docs/zaibie-tiannan-design.md。 */
  {
    ...
    name: "金鼓原",
    desc: "天南正道与魔道大军决战的旷野——战鼓如雷、血染黄沙。黑煞教倾巢而出，灵兽山倒戈反水，正道节节败退。李化元坐镇催开的护山大阵，是这溃局里最后一道光。",
  ...
  },
  {
    ...
    name: "越国矿洞 · 古传送阵",
    desc: "胥国边陲一座废弃矿洞的最深处，藏着一座尘封万载的古传送阵。残破的阵纹仍透着幽光——照着辛如音所赠图纸补全阵纹、加上大挪移令，便能强启这跨域大阵，一步踏出天南。身后，魔道的追兵已踏碎洞口。",
