...
WORLD.npcs = [
  ...
  {
    id: "mei_ning", name: "梅凝", role: "同陷阴冥的女剑修 · 筑基后期",
    bio: "被鬼雾卷入阴冥之地的年轻女剑修。绝灵之地剑修的骄傲一文不值，她却在灰蜮夜袭中舍身护住一个扑错方向的村中孩童。与韩立、紫灵结伴攀暴风山，风眼白光里同出生天——绝地里交出的后背，比任何盟书都重。",
    lines: ["你那剑法——不是修士的剑，是杀出来的剑。", "堂堂剑修，在这儿连个孩子都护得狼狈。", "（她守夜时的背，朝你这边转了）"],
    where: [],
  },
  {
    id: "yinyue", name: "银月", role: "青竹蜂云剑器灵 · 化形",
    bio: "狼首玉如意中沉睡的灵识，经青竹蜂云剑温养经年，于天南山中化形——银发银眸的少女，睡眼惺忪却把主人的剑养得雷光湛湛。御剑、掌灯、看家、并肩而战：韩立此后道途上最重要的伙伴之一。",
