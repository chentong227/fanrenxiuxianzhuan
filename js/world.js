...
WORLD.locations = [
   ...
   *   polish-zaibie B1（Fable P0-4 + GPT P0-2）：jinguyuan/yuekuang 两段帆窗（a3_due+2月/kuangdong_due+1月）
   *   原为 scene:true+actions:[]＝"没有门的房间"（唯一耗月手段是出门云游）——去 scene 化、补最小行动
   *   （场景底图走 art.js LOC_CG 兜底：jingu_yuan/chuansong_zhen 横竖在库，不依赖 scene 标记）。 */
  {
    id: "jinguyuan", arc: "zaibie",
    name: "金鼓原",
    desc: "天南正道与魔道大军决战的旷野——战鼓如雷、血染黄沙。黑煞教倾巢而出，灵兽山倒戈反水，正道节节败退。李化元坐镇催开的护山大阵，是这溃局里最后一道光。大战方歇，残军在阵幕后的焦土上暂驻扎营——你也在这里落了脚。",
    // 决战旷野·黄沙：2.5D 前景＝山野框（底两角近岩·开阔），远雾极浓（战尘弥漫·空气透视）
    env: { depth: { fg: "mountain", far: 0.58 } },
    travelCost: 1, actions: ["rest"], actionLabels: { rest: "残营调息" }, encounters: [],
  },
  {
    id: "yuekuang", arc: "zaibie",
    name: "越国矿洞 · 古传送阵",
    desc: "胥国边陲一座废弃矿洞的最深处，藏着一座尘封万载的古传送阵。残破的阵纹仍透着幽光——照着辛如音所赠图纸补全阵纹、加上大挪移令，便能强启这跨域大阵，一步踏出天南。",
    // 废弃矿洞最深处·古传送阵：2.5D 前景＝洞口岩壁框（"从洞里往外看"的纵深），远雾极浓（幽深矿道）
    env: { depth: { fg: "cave", far: 0.6 } },
    travelCost: 1, actions: ["rest", "xiuzhen"], encounters: [],
  },
  {
...
WORLD._landContinent = {
  ...
  nodes: [
    ...
    { id: "huangfeng", name: "黄枫谷", pos: { x: 56, y: 13 }, locs: ["huangfeng_gate", "baiyao_yuan", "fangshi", "wulong_tan", "guwai_lin"], localMap: "huangfeng_gate",
    ...
    { id: "jiayuan",  name: "嘉元城",  pos: { x: 44, y: 60 }, locs: ["jiayuan_city"], localMap: "jiayuan_city",
      ...
      gate: (s) => s.flags.arc1_complete ? null : "七玄门之事未了" },
    { id: "tainangu", name: "太南谷",  pos: { x: 28, y: 80 }, locs: ["tainan_fair", "tainan_yelin"], localMap: "tainan_fair",
...
WORLD.enemies = {
  ...
  fengyue: {
    ...
    // canon P2·书页合璧（红袖「金银书页」词条：动漫版金页=击杀封岳后获得）——青元剑诀全本线的上半页
  ...
  xuwang_shenhun: {
    ...
    introNote: "平天尺、重元珠、赤虹剑——韩立、宋蒙、陈巧倩三件符宝齐轰而下，胥王那具假丹肉身轰然崩碎！可血凝五行丹借阵中五行之力，竟凝起一缕复生神魂——肉身已毁、神魂残虚，却仍要夺舍逃命！颠倒五行阵正死死镇着它，趁此底牌齐发将其打散——真凰符已在钟卫娘手中蓄势，只待这一击。",
    attacks: [
...
WORLD.npcs = [
  ...
  {
    id: "dongxuaner", name: "董萱儿", role: "黄枫谷 · 红拂座下",
    // canon M2（2026-07-10 勘正·董萱儿词条+新浪+头条三源）：她是红拂（黄枫谷第一结丹女修·其师）与
    // 合欢宗云露老魔的私生女、天生媚体——身世成谜正是她被掳去合欢宗「认亲」的根由
    bio: "黄枫谷第一结丹女修红拂的座下弟子，眉眼高华、心思深沉，身世讳莫如深——门中只知她自幼由红拂亲手带大，来历无人敢问。陆云风当年正是为攀附她这条线，才对道侣陈巧倩痛下杀手（那笔血债，最终算在了你手上）。燕家堡之战中她与你并肩御魔——这位心高气傲的天之骄女，记下了你这个伪灵根筑基。",
  ...
  // —— 再别天南·金鼓原殉道场两位（polish-zaibie C5·Fable P2-4：情感顶点一场的怀抱者与对手入图鉴）——
  //    考据锚 ep53/57（canon-audit M1/Z3）：红拂=黄枫谷第一结丹女修·李化元师姐·董萱儿之师·法宝风云幡；
  //    云露老魔=合欢宗元婴中期·擒红拂压境与李化元立赌。
  {
    id: "hongfu", name: "红拂", role: "黄枫谷 · 第一结丹女修",
    bio: "黄枫谷第一结丹女修，李化元的师姐、董萱儿之师，一幅风云幡名动天南。金鼓原崩盘之际她重伤被云露老魔所擒——李化元一步踏出护山光幕，以碎丹一诺从元婴老魔手里把她赢了回来。那道白须身影最后倒在她怀中，气息散尽时，嘴角带着笑。",
    lines: ["（她抱着怀中渐冷的身影，久久没有说话）", "师弟他……这一局，赢得太贵了。", "黄枫谷的根还在——他托付你的，我也记下了。"],
    where: [],   // 纯图鉴：金鼓原殉道场 meetNpc 录入
  },
  {
    id: "yunlu", name: "云露老魔", role: "合欢宗 · 元婴中期老魔",
    bio: "合欢宗的元婴中期老魔，慵懒散漫、眼帘半垂，像什么都不值得他认真——正因如此，他「认真出上一手」才成了李化元赌约的注码。金鼓原护山光幕外，他拎着重伤的红拂踏空而来，被李化元碎丹一击逼得敛去嗤笑、挥袖凝罡认真接下，随后掷下红拂、一句「算你赢」，收兵而去。魔道中人，倒也认赌。",
    lines: ["（他眼帘半垂，似笑非笑地打量着光幕内的众人）", "就凭你？好，老夫陪你赌。", "……算你赢。合欢宗，今日收兵。"],
    where: [],   // 纯图鉴：金鼓原殉道场 meetNpc 录入
  },
  {
  ...
  {
    // canon M3（2026-07-10 勘正·百科宋蒙条）：李化元门下行四；豪放血性、逢厮杀就兴奋——旧"稳重缜密"写反
    id: "songmeng", name: "宋蒙", role: "黄枫谷 · 李化元门下行四",
    bio: "黄枫谷筑基中期修士，李化元门下行四——豪放血性，一逢厮杀眼睛就亮，笑声比刀光先到。手中一枚「重元珠」是压箱底的护身大件。与刘靖之间似有一段不便明言的旧渊源——金鼓原集结时只与你点头之交，那段渊源是后话。",
    lines: ["前线天天有仗打——依宋某说，这地方来得太对了！", "（他掂了掂掌心一枚温润圆珠，咧嘴一笑）韩师弟，比比斩获？", "痛快！魔修这种东西，就该放开了打！"],
    where: [],
  },
  {
  ...
  {
    // canon M3/M4（2026-07-10 勘正·百科武炫条）：李化元门下行六的同门师弟，因董萱儿对韩立抱有情绪；
    // 命途=未随剿黑煞教，被青纹/叶蛇掳走、死于皇宫密室被吸尽精血（M4 收口见 modao_e4_shenxun）
    id: "wuxuan", name: "武炫", role: "黄枫谷 · 李化元门下行六",
    bio: "黄枫谷筑基初期修士，李化元门下行六——年轻气盛，斗起法来倒是嗷嗷叫的一把好手。只是他心仪董萱儿师姐多年，听得师姐夸过你那柄乌龙夺，便对你这位半路的『记名师兄』横竖看不顺眼。巡逻遭遇战里与你并过肩——并肩归并肩，好脸色是没有的。",
    lines: ["记名师兄？呵，师父的门墙如今是宽了。", "巡逻自己当心，我可顾不上你。", "（他斗完魔修，抹了把血污，斜你一眼）……这一场，算你出的力多。"],
    where: [],
  },
   ...
   *   canon 追认②（2026-07-10 用户拍板恢复双体制·豆瓣长评+百科黑煞教主条双源）：越皇=黑煞教主**本体**；
   *   外间行走的「黑煞教主」=其唯一**身外化身**（兄弟献身所祭·体内血凝五行丹）——胥王原台词「他是我唯一
   *   预备好的身外化身」。皇宫决战：本体装凡人君主潜伏、暴起偷袭刘靖（阴手剧情杀），随即血池中化身破水
   *   归窍、二体合一跃入假丹境（战斗仍单一 boss·平衡不动）。旧"第五血侍"自造术语已删。 */
  {
    id: "xuwang", name: "胥王", role: "黑煞教主真身 · 越皇",
    bio: "黑煞教真正的教主，亦是越国之主。外间人人惧称的那尊「黑煞教主」，不过是他以兄弟献身所祭的身外化身（体内温养着血凝五行丹）；他自己则藏在越国君王的温吞皮相之下，凡人一般坐了半生龙椅。皇宫决战中，他待刘靖凤凰符尽兴、防备一松，暴起以阴手偷袭；继而当众褪去凡人皮囊，血池中化身破水归窍、二体合一，神魂气息暴涨直入假丹之境（筑基巅峰）。",
    lines: ["（一身越王常服，温声笑着）诸位仙长远来辛苦，寡人……备了些薄礼。", "（皮囊寸寸剥落，声音陡然森冷）装了这许多年凡人，也该腻了。", "（血池炸开、化身归窍）它是寡人唯一预备好的身外化身——假丹之威，岂是尔等筑基蝼蚁可挡？"],
  ...
  {
    id: "zi_ling", name: "紫灵", role: "妙音门门主 · 客卿引路人",
    bio: "当年镇妖大典惊变中被韩立从乱军里救下的孤雏汪凝（小紫灵），如今已长大成人——结丹修为、妙音门门主（天星城辞别后亲手撑回了爹娘的门派），名动内星海的一位女修。心计深沉、调度有方，却独独对那位「韩大哥」存着一份外人看不透的亲近。她递来的邀帖背后，是蝎岛、是天雷竹、是虚天殿——星海飞驰篇真正的线头，都系在她手里。",
    lines: ["韩大哥别来无恙——当年那个躲在你身后哭的丫头，如今也能为你撑一把伞了。", "妙音门要一位结丹期客卿长老，报酬绝不亏待故人。", "（她眸光微动，似有话未尽）有些事，等你应了这桩差事，再慢慢说与你听。"],
    where: ["tianxing_city"], cond: (s) => s.metNpcs && s.metNpcs.includes("zi_ling"),
  },
  {
    // canon X1（2026-07-10 勘正）：赵峥/符长老=**星宫派驻**妙音门的客卿（内奸·暗通极阴）；紫灵的盟友=星宫金魁
    id: "zhao_zheng", name: "赵峥", role: "星宫派驻妙音门客卿 · 结丹中期",
    bio: "星宫派驻妙音门的结丹中期客卿长老，暗地里却与符长老一道勾结极阴岛、出卖门中机密。蝎岛之战不过是个幌子——紫灵与星宫金魁合作设局，既钓极阴现身，也要借这场仗清除这两条门中蛀虫。被暗算削弱真元、护体法宝寸裂之后，他这身结丹中期的修为，也就剩个空架子了。",
    lines: ["哼，妙音门的差事，也轮得到你一个外来散修指手画脚？", "（他眼神闪烁，护体灵光时明时暗）你……你们早有预谋！", "极阴岛不会放过你们的——"],
    where: [],   // 纯图鉴+战斗：蝎岛节点 meetNpc 录入
  },
  {
    // canon X1（2026-07-10 勘正·腾讯20231209+movie-247 双源）：孙门主=极阴老祖叛出的弟子（乌丑师叔）、
    // 手握虚天殿残图——他是紫灵与星宫这局棋的**饵**，不是同谋棋手
    id: "sun_menzhu", name: "孙门主", role: "隐煞门门主 · 极阴叛徒",
    bio: "隐煞门门主，结丹中期——极阴老祖叛出的弟子、乌丑的师叔，手里捏着半幅虚天殿残图。他自以为据蝎岛称雄，殊不知妙音门攻岛是紫灵与星宫金魁合作的一场局：他这枚『饵』，钓的正是循残图与叛徒而来的极阴岛。",
    lines: ["妙音门？也敢来捋本座的虎须！", "（他神色骤变，望向天际那道幽冷身影）师门的人……怎么会找到这里！", "残图在本座手里——你们谁都别想拿走！"],
    where: [],
  },
  {
    id: "jiyin_zushi", name: "极阴祖师", role: "极阴岛岛主 · 元婴初期顶峰",
    bio: "魔道极阴岛之主、元婴初期顶峰的老怪物，玄骨上人（萧诧）的徒弟。素来藏身幕后、以附身控制之法借乌丑行事——那幽冷得不似活人的声气，分明是借着旁人的口在说话。元婴之威煌煌如渊，结丹修士在他面前连喘息都是奢侈。日后虚天殿中，他将因韩立的血玉蜘蛛而起意收徒——当然，是要利用完便弃的那种。",
    lines: ["（乌丑的口中，吐出的却是另一个苍老阴冷的声音）蝼蚁的挣扎，倒也有趣。", "活捉了，本座要细细地问。", "（元婴威压如有实质，压得周遭修士几乎站立不稳）"],
    where: [],
  },
  {
    id: "jin_qing", name: "金青", role: "散修 · 结丹 · 虚天殿引路人",
    bio: "乱星海一名结丹散修，与韩立有些旧交。为人爽利、消息灵通，邀韩立同探一处古修士遗址练手——却不知那遗址深处，封印着一位改修鬼道的元婴老怪。古修士洞府一行，金青有去无回。",
    lines: ["韩道友！这处古修士洞府，寻常人可进不去——同去开开眼界？", "石蝶、老胡都是老搭档了，路上有个照应。", "（他拍着储物袋，满脸憧憬）这一趟若能淘换到件像样的古宝，下半辈子就不愁了。"],
    where: [],
  },
  {
    id: "xuangu", name: "玄骨上人（萧诧）", role: "前元婴后期 · 鬼道 · 夺舍曲魂",
    bio: "本名萧诧，极阴祖师与极炫的师父，生前元婴后期修士，被徒弟陷害封印于古修士洞府，改修鬼道后实力大降（韩立评估约结丹后期）。在古修士洞府现身、一击秒杀金青，更夺舍了曲魂的身躯重获肉身——从七玄门一路陪伴韩立至今的曲魂，在这一刻被生生夺走。日后虚天殿中，他将是韩立以下克上的终战之敌。",
    lines: ["这具尸傀的躯壳……倒是难得的好皮囊。", "（鬼骷髅森森冷笑）一个结丹小修，也配多管闲事？", "老夫蛰伏百年，要的不过是一具能承载残魂的肉身罢了。"],
    where: [],
  },
  {
    id: "yuan_yao", name: "元瑶", role: "结丹修士 · 妍丽之友 · 面纱伪装",
    bio: "一位戴面纱的结丹女修，为复活亡友妍丽而入虚天殿寻养魂木。冰火道中被铁火蚁群所困、为韩立所救。她欲以身相许、又以三枚青火雷（魔道青阳门秘制·一枚抵元婴一击）相谢，皆被韩立婉拒；韩立只取了她随身的啼魂兽与鸣魂珠。还阳术与妍丽复活的因果，留待外海风云篇。",
    lines: ["这位道友援手之恩，元瑶没齿难忘。", "啼魂兽天生克制鬼物精魂，道友既喜欢，便赠予你罢。", "（面纱之后，目光里藏着一桩执念）我此来，只为一个人。"],
    where: [],
  },
  {
    id: "man_huzi", name: "蛮胡子", role: "元婴中期 · 魔道最强之一",
    bio: "魔道元婴中期的巨擘，须发如戟、性情豪烈。虚天殿中盯上韩立的血玉蜘蛛（拉鼎之钥），先在冰火道赠下宝珠、后赠成名防御法宝『皇鳞甲』拉拢韩立——元婴大战中，正是皇鳞甲替韩立挡下致命一击。各怀鬼胎的三元婴里，他对韩立算是最存了几分『真』的一个。后被极阴暗算囚禁（远线）。",
    lines: ["小子，你那只血玉蜘蛛，老夫看上了——别急着拒绝，先收下这件甲。", "（须发戟张，声若洪钟）这虚天殿里，信谁都不如信老夫一回。", "拿人手短？哈哈，那你就欠着老夫一份人情。"],
    where: [],
  },
  {
    id: "qingyi_jushi", name: "青易居士", role: "元婴初期 · 南鹤岛散修",
    bio: "南鹤岛的元婴初期散修，文质彬彬、笑里藏刀。与极阴争抢收韩立为徒，赠『青冥针』符宝以示拉拢——表面关切，实则觊觎血玉蜘蛛。这枚符宝日后成了韩立出虚天殿时冒充其徒弟蒙混过关的信物：虚情假意，倒也阴差阳错地帮了韩立一把。",
    lines: ["韩道友天资难得，不如拜入我门下，如何？", "（含笑递来一枚符宝）这青冥针，便算是见面礼了。", "虚天殿龙潭虎穴，有我青易居士照拂，道友可安心许多。"],
    where: [],
  },
  {
    id: "wan_tianming", name: "万天明", role: "元婴期 · 万法门",
    bio: "万法门的元婴修士，正道一方取鼎的代表。虚天殿内殿以金丝蚕之法取虚天鼎失败，假意愤然离去——实则金魁暗中分化正魔两派、赐下天机造物仪的一步棋。元婴大战中，他一行人闯入与魔道三元婴混战。",
    lines: ["金丝蚕取鼎之法，竟也不成……", "（拂袖）此鼎与我万法门无缘，告辞！", "魔道宵小，也配染指虚天鼎？"],
    where: [],
  },
  {
    id: "wen_tianren", name: "温天仁", role: "结丹后期巅峰 · 六道极圣之徒",
    bio: "逆星盟魔道魁首·六道极圣的亲传弟子，结丹后期巅峰，号称乱星海元婴之下第一人。清秀斯文、麻衣高冠赤足，眉宇间隐有金芒，性情却骄纵张扬。修魔界顶级功法六极真魔功（可幻化六魔各司其职），持仿品八门金光镜、金针剑、四象蟠龙带等顶级法宝。虚天殿出口看守离岛时与韩立初遇——韩立凭青易居士所赠的青冥针冒充其徒弟蒙混过关。两人真正的正面对决，留在外海风云篇。",
    lines: ["出殿者留下名号——你是哪一脉的？", "青易居士的徒弟？……也罢，过去吧。", "（目光在你身上停留一瞬，似有疑窦）"],
    where: [],
  },
  {
    id: "gongsun_xing", name: "公孙杏", role: "外海散修 · 筑基后期",
    bio: "无门无派的外海散修，为采灵药救父（真元逆转）出海遇兽潮，误闯韩立孤崖洞府所在而获救。性情刚毅重诺，甘愿为奴为婢换父亲一线生机。裂风岛地底洞穴崩塌时随韩立乘乱逃生——恶名满海的岁月里，公孙一家是少数肯为『韩老魔』三个字辩白的人，据说事后还为恩公立了生祠、世代供奉。",
    lines: ["前辈救命之恩，公孙杏没齿难忘。", "『韩老魔』的真假，我们一家替前辈说与人听。", "（她把丹方折得整整齐齐，贴身收着）"],
    where: [],
  },
  {
  ...
  {
    id: "mei_ning", name: "梅凝", role: "同陷阴冥的宗门女修 · 筑基后期",
    bio: "与兄长一同被鬼雾卷入阴冥之地的宗门女修，入雾后兄妹走散。绝灵之地修士的骄傲一文不值，她却在祭品之夜抄起门闩替韩立挡了背后一刀——说是替失散的兄长积德。伤口周围隐有玉光流转、愈合奇速，她自己浑然不觉（通玉凤髓之体？）。与韩立、紫灵结伴攀暴风山，罗睺裂缝的白光里同出生天——绝地里交出的后背，比任何盟书都重。",
    lines: ["你那剑法——不是修士的剑，是杀出来的剑。", "我兄长还在这鬼地方……路上，帮我留意一眼。", "（她守夜时的背，朝你这边转了）"],
    where: [],
  },
  {
    id: "feng_tianji", name: "封天极", role: "阴冥村猎户 · 吃人规则的终结者",
    bio: "阴冥村的疤脸猎户，寡言、凶相，村人多有惧他。祭品之夜却是他第一个提刀反水——「拿活人喂兽，咱们和阴兽有什么分别！」与韩立背靠背杀翻兽晶邪身的大长老，一脚碾碎兽晶。此后村中再不吃人；韩立一行上暴风山的路，也是他指的。",
    lines: ["够了！这村子疯了——仙师，我帮你！", "往后，村里不吃人了。", "（他拿猎叉朝灰白的天际点了点：山顶那道缝，快了）"],
    where: [],
  },
  {
    id: "yinyue", name: "银月", role: "青竹蜂云剑器灵 · 夺舍化形",
    bio: "狼首玉如意中沉睡的银月狼族灵识。天南山中韩立遭凶灵设伏，她银芒暴涨、以灵魂吞噬的天赋夺舍一头雪云狐得了肉身，按碎凶灵救主——随后主动认主、移灵入青竹蜂云剑为器灵。银发银眸的少女，睡眼惺忪却把主人的剑养得雷光湛湛。御剑、掌灯、看家、并肩而战：韩立此后道途上最重要的伙伴之一。",
    lines: ["器灵银月，拜见主人。", "主人的剑养得真好，银月在梦里都闻得到雷的味道。", "（她盘坐在剑柄上打盹，剑身微微发亮）"],
    where: [],
  },
  {
    id: "ling_yuling", name: "凌玉灵", role: "星宫双圣之女 · 筑基后期",
    bio: "星宫双圣之女，筑基后期。出虚天殿后被外海妖兽围困，为韩立所救。这一份救命之情，是韩立与星宫双圣关系线的种子——外海风云篇中自有回响。",
    lines: ["多谢道友援手……我是星宫凌氏，凌玉灵。", "此恩，玉灵记下了，他日必报。", "（劫后余生，望着你的目光里多了几分郑重）"],
    where: [],
  },
  {
