...
WORLD.npcs = [
  ...
  {
    id: "zi_ling", name: "紫灵", role: "妙音门少主 · 客卿引路人",
    bio: "当年镇妖大典惊变中被韩立从乱军里救下的孤雏汪凝（小紫灵），如今已长大成人——结丹修为、妙音门少主，名动内星海的一位女修。心计深沉、调度有方，却独独对那位「韩大哥」存着一份外人看不透的亲近。她递来的邀帖背后，是蝎岛、是天雷竹、是虚天殿——星海飞驰篇真正的线头，都系在她手里。",
  ...
  {
    id: "zhao_zheng", name: "赵峥", role: "妙音门客卿长老 · 结丹中期",
    bio: "妙音门挂名的结丹中期客卿长老，暗地里却与符长老一道勾结极阴岛、出卖门中机密。蝎岛之战不过是个幌子——紫灵早已联手隐煞门孙门主设下棋局，要借这场仗清除这两条门中蛀虫。被暗算削弱真元、护体法宝寸裂之后，他这身结丹中期的修为，也就剩个空架子了。",
    lines: ["哼，妙音门的差事，也轮得到你一个外来散修指手画脚？", "（他眼神闪烁，护体灵光时明时暗）你……你们早有预谋！", "极阴岛不会放过你们的——"],
    where: [],   // 纯图鉴+战斗：蝎岛节点 meetNpc 录入
  },
  {
    id: "sun_menzhu", name: "孙门主", role: "隐煞门门主 · 结丹中期",
    bio: "隐煞门门主，结丹中期。表面与妙音门是死对头，暗中却与紫灵达成默契——蝎岛之战是两家联手做的一场局，真正要清的是混在妙音门里勾结极阴岛的叛徒。城府极深，与紫灵一般是棋手而非棋子。",
    lines: ["妙音门的少主果然好手段……这场戏，唱得不错。", "叛徒人人得而诛之，与正魔无关。", "（他遥遥向紫灵颔首，心照不宣）"],
    where: [],
  },
  {
