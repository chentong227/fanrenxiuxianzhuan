...
WORLD.locations = [
  ...
  /* —— 自由探索地点（异闻录·恒在原则的承载：怪/材客观盘踞，听闻只叠预知）—— */
  {
    id: "wulong_tan",
    arc: "huangfeng",
    name: "黄枫谷 · 乌龙潭",
...
WORLD.enemies = {
  ...
  guwai_yaowang: {
    ...
    attacks: [
      ...
      { name: "震林啸", dmg: 15, kind: "normal", weight: 6, aim: "zone", zoneSpan: 1, range: [1, 4] },
...
/* ---------- 异闻录图鉴（恒在原则·七效预知层，docs/lore-大件依赖图.md §0.3）----------
 ...
 * 恒在：所有怪/材/入口客观存在；异闻只叠"预知/助力/赏金"七效（①指路②识弱③召援④悬赏⑤备战⑥避坑⑦借物），非门槛。
