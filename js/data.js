...
DATA.realms = [
  ...
  // —— 结丹期（大境界：觅长生式渡劫——三转重元功+大衍诀入修+降尘丹/雪灵水/天火液/妖丹，见 DATA.bigRealmRites.core）——
...
DATA.items = {
  ...
  pingtian_chi_charge: { name: "平天尺·蓄势", rarity: "epic", type: "consumable",
    desc: "决战前夜，师兄妹以颠倒五行阵的阵力，替你把吕天蒙遗下的平天尺灌注了一式蓄势——只此一击，机会只在皇宫决战。「替我，带出去。」这一击，也替他。" },
  ...
  /* 妖材→法宝链·首件落地：墨蛟双角 → 乌龙夺（四爪毒法宝，黄枫谷篇·齐云霄代炼） */
  wulong_duo: { name: "乌龙夺", rarity: "epic", type: "gear",
    desc: "以墨蛟双角为材、元武国巧匠齐云霄炼成的四爪短法宝：四枚墨绿蛟爪攥成一握，御空飞出时凌空连抓，爪尖淬着墨蛟体内未散的水行妖毒——抓痕见血、毒发缠身。小巧凶毒，是血色禁地那场死战留下的獠牙。练气十一层方可驱使。" },
  ...
  wulong_duo: { name: "乌龙夺", rarity: "epic", type: "gear",
    desc: "以墨蛟双角为材、元武国巧匠齐云霄炼成的四爪短法宝：四枚墨绿蛟爪攥成一握，御空飞出时凌空连抓，爪尖淬着墨蛟体内未散的水行妖毒——抓痕见血、毒发缠身。练气十一层方可驱使。" },
  ...
  // canon P2·青元剑诀书页合璧线（红袖「金银书页」词条·动漫版金页=杀封岳所得；银页=燕家堡前李化元处自选功法所得——合璧藏完整十三层）
  jinse_shuye: { name: "金色书页", rarity: "epic", type: "treasure", keepsake: true, bound: true,
    desc: "自封岳尸身上搜得的一页金色薄篇，非金非帛、刀火不侵——页上剑诀残文与《青元剑诀》一脉同源，却远比谷传九层版深奥。似乎只是上半页：还有与之成对的另一页在世间。（青元剑诀全本·十三层之钥·上半）" },
  yinse_shuye: { name: "银色书页", rarity: "epic", type: "treasure", keepsake: true, bound: true,
    desc: "燕家堡之行前自李化元藏书阁自选功法时无意所得的一页银色薄篇——与金色书页纹理相合，正是成对的下半页。金银合璧，隐见《青元剑诀》完整十三层法诀与青竹蜂云剑炼制之法的端倪。（青元剑诀全本·十三层之钥·下半）" },
  ...
  jiangchen_dan: { name: "降尘丹", rarity: "epic", type: "pill",
    desc: "六连殿镇妖大典许诺的榜首之酬——大典惊变未及颁下，最终自反水的古长老尸身上缴获（canon S4）。服之可涤去筑基灵力中最后一缕尘浊、大降结丹一关的凶险门槛。结丹本是九死一生，得此丹便多三分生机。（结丹关·破关之资）" },
  ...
  leipeng_yu: { name: "雷鹏遗羽", rarity: "epic", type: "material",
    desc: "镇妖大典惊变时自雷鹏坠处拾得的一枚遗羽，通体铅灰、羽脉间雷光游走不熄，入手微麻。风希取走双翅主翎炼「风雷翅」——这枚散落的遗羽，是那门元婴级遁术之材的唯一线索实物。（乱中拾遗·外海风云伏笔）" },
  banyao_cao: { name: "伴妖草", rarity: "rare", type: "material",
    desc: "生于大妖巢穴左近的莹白灵草，饱吸妖气而不染其性——炼制傀儡灵物的奇材，也是结丹大圆满破关丹方里的一味主药引。裂风兽洞口崖缝里采得的这几株，代价可不小。" },
  santou_tongpian: { name: "三头六臂铜片", rarity: "epic", type: "material",
    desc: "沧澜坊市地下拍场以一颗妖丹换来的残破铜片，锈迹斑驳间隐见三头六臂的法相纹路——细察竟隐载一门妖修功法的残篇，法相狞恶、深不可测，不敢修习。收下它的那一刻，某条极远的线，已经悄悄系在了你身上。（外海风云·拍场拾遗·远线功法伏笔）" },
  ...
  xutian_tucan: { name: "虚天残图", rarity: "epic", type: "key",
    desc: "金魁因蝎岛清查叛徒之功赐予紫灵的一片古图残卷，绘着三百年一开的『虚天殿』方位与开启之机。紫灵将它取出、邀你同探——图不全，却已是无数元婴老怪求而不得的引线，内藏上古大能遗宝：虚天鼎、乾蓝冰焰……（虚天殿·线启动·源出金魁赐紫灵）" },
  jinleizhu: { name: "万年金雷竹", rarity: "legendary", type: "material",
    desc: "天雷竹以小绿瓶灵液反复催熟、压了万年之功于一瞬——青翠转作流金，竹身雷纹奔涌如活物。这便是炼制七十二口青竹蜂云剑的成材。三大神木催到此境，举世再难寻第二份。（青竹蜂云剑·成材·待开炉）" },
  ...
  xutian_ding: { name: "虚天鼎", rarity: "legendary", type: "treasure", natal: true,
    desc: "乱星海第一秘宝——上古大能炼制的通天灵宝，鼎身万纹流转、内可纳天地。虚天殿中白玉蜘蛛拉鼎而出，元婴老怪混战夺鼎，韩立浑水摸鱼智取而得。日后炼化，可成镇压一世的大杀招。（通天灵宝·韩立第一件·远期炼化）" },
  ...
  // canon Z4 勘正：辛如音不随行矿洞、不死——图纸=她与齐云霄毕生推演，绝笔改托付之信（她还活着·灭付家远线的宿题人物）
  guzhen_tuzhi: { name: "古传送阵·修复图纸", rarity: "epic", type: "treasure",
    desc: "辛如音与齐云霄毕生推演的一幅阵图——越国矿洞那座残破古传送阵的修复与催动之法尽在其上。配上大挪移令，便能强启这座尘封万载的跨域大阵，一步踏出天南。此图既是你脱身天南的钥匙，也是你日后钻研阵法之道的开端。" },
  xinruyin_letter: { name: "辛如音的托付之信", rarity: "epic", type: "treasure", keepsake: true, bound: true, from: "xinruyin",
    desc: "辛如音随图纸附上的一枚玉简，字迹清瘦：「韩道友，齐前辈的阵，托付给你了。替我们……去看看天南之外的天地。若有归日，元武国百艺坊，或还有一盏灯亮着。」" },
  ...
  // —— v354 苍坤上人遗迹·四大宝盒（动漫 174~176 考据：银月瞒天过海取三 + 南陇侯赠一） ——
  liangyi_yinhuan: { name: "两仪环 · 阴环", rarity: "epic", type: "treasure", keepsake: true, bound: true,
    desc: "玄黄老人所炼成套古宝之一。此环看似朴拙、毫无攻伐之力，却能无损抵御「北极元光」——险地探宝的保命符。懂行的都知道：它真正的分量，要等阳环现世、双环合璧那一天。（坠魔谷北极元光的克星——收好它）" },
  shijue_jiudu: { name: "十绝鸠毒", rarity: "epic", type: "treasure",
    desc: "苍坤上人遗藏的十种绝毒合炼之物，无色无味、沾之即溃。以你的用毒造诣，此物在关键一击里能出奇制胜——毒杀元婴，也不是没有先例。（底牌·剧情关键时刻自有用处）" },
  zicheng_dou: { name: "紫铖兜", rarity: "epic", type: "treasure",
    desc: "一顶流转紫芒的古兜，罩下时如紫幕垂天、困敌护主两相宜。你掂了掂，心里已有了主意——银月正缺一件趁手的护身重器。（护持之宝·可托付器灵）" },
  cangkun_yujian: { name: "苍坤遗泽玉简", rarity: "epic", type: "treasure",
    desc: "苍坤上人手书的一枚功法玉简，所载法门残缺却精深——单是边角的御空要诀，已足够寻常元婴修士参悟半生。（元婴期修行资粮·闭关参研自有进益）" },
};
...
DATA.gear = {
  ...
  // —— 元武国·齐云霄代工（墨蛟之角炼成的四爪带毒攻击法宝——韩立筑基期第二主战；授予见 story.js 增量C）——
  wulong_duo: {
    slot: "weapon", minLayer: 11,
    bonus: { sense: 1 },
    grantSpells: ["wulong_zhua"],
    traits: [{ id: "venom_claw", desc: "墨蛟毒爪：战斗技「乌龙夺」四爪连抓、每爪独立结算，命中令敌中毒持续掉血——攻击带毒，缠斗愈久愈致命" }],
  },
...
DATA.bigRealmRites = {
  ...
  core: {
    name: "结丹关 · 凝灵成丹",
    intro: "筑基百窍灵力已盈，再难寸进——欲破此关，须以三转重元功散功重修、淬出一身精纯真元，更以大衍诀入门法门凝炼神识，方堪驾驭结丹之劫。临关再以降尘丹涤尽尘浊、雪灵水与天火液一寒一热相济，将一身灵力反复压炼、凝散为丹。结丹心魔为平生执念所化，最是难缠；首番叩关，鲜有不败。此乃「觅长生」之关——备得越足，活路越宽。",
    require: [
      { kind: "flag", key: "sanzhuan_done",  label: "三转重元功·重元一转（散功重修圆满）" },
      // canon-audit S1（2026-07-10 勘正）：大衍诀高层与结丹无关（红尘劫在结丹后·对应第四层）——
      // 结丹前置由「大衍诀三层」改「入修淬炼神识」（dayan_learned·ziliang 节点立）
      { kind: "flag", key: "dayan_learned",  label: "大衍诀·入修（神识淬炼大成）" },
