...
DATA.items = {
   ...
   *   绿煌剑＝御灵宗夺舍者本命法宝（结丹本命），韩立越阶驱使发挥不出结丹本命全威（A2 driveRealm:2·非本命·越阶×0.45，但基数高），
   *   配剑影分光术，仍是金蚨子母刃→乌龙夺之后的强力第三主战。曲魂·身外化身装黑煞教主血刃达假丹境（SideUnit 友军）。 */
  lvhuang_jian: { name: "绿煌剑", rarity: "epic", type: "gear",
    desc: "御灵宗夺舍者（败于你手那位）的本命法宝：一柄通体莹绿、剑吟如龙的古剑，结丹本命所凝，威能远在寻常法器之上。你越阶强驱、发挥不出它结丹本命的全威——但即便如此，配上剑影分光之术，仍是继金蚨子母刃、乌龙夺之后的第三件强力主战法宝。" },
...
DATA.gear = {
  ...
  // —— 再别天南·夺剑（御灵宗夺舍者本命法宝·结丹本命）：韩立越阶强驱发挥不出结丹本命全威（driveRealm:2 非本命·越阶×0.45），
  //    但基数高、配剑影分光术，仍是金蚨子母刃→乌龙夺之后的第三件强力主战法宝（授予见 story.js Act1 御灵宗夺舍者战胜后）——
  lvhuang_jian: {
    slot: "weapon", minLayer: 11,
    bonus: { sense: 2, body: 1 },
    grantSpells: ["lvhuang_jian", "jianying_fenguang"],
    traits: [{ id: "lvhuang_sword", desc: "越阶御剑：战斗技「绿煌剑」势大力沉、「剑影分光」分影多段——结丹本命之器，你越阶强驱只得其四五分威，仍冠绝筑基（御灵宗夺舍者本命法宝）" }],
  },
  // —— 属性/特性类（被动）——
  xuantie_dun: {
