...
| 8 | 立绘 | 厉飞雨大笑张臂被图片矩形边直切 | P1 | ✅ v301 已修（返修重生成——双臂收拢入画，边缘干净） |
...
## 六、P2 生图批（✅ 2026-07-09 已跑完·用户新 key·flash 模型省费）

> 40 张全部入库注册（唯 bt_chenqiaoqian 首版带黑底重生成一次）。以下保留原阻塞记录与命令备查。
> 花费参考：flash 单价约 $0.03/张，全批 ≈ $1.2。
